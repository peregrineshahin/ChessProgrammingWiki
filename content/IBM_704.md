...
```C++[Life magazine](https://en.wikipedia.org/wiki/Life_(magazine)) came asking for photographs of [Bernstein](Alex_Bernstein "Alex Bernstein") sitting at the computer, and wondered if they could get [Bobby Fischer](https://en.wikipedia.org/wiki/Bobby_Fischer) to pose too. He was in his early teens at the time, but shrewd enough, and said he would for a fee of $2500, Bernstein recalls: 
