...
title: ICGA
---
**[Home](Home "Home") * [Organizations](Organizations "Organizations") * ICGA**
...
- to hold regular [World Computer-Chess Championships](World_Computer_Chess_Championship "World Computer Chess Championship"), [Computer Olympiads](Computer_Olympiad "Computer Olympiad"), and [Advances in Computer Games](Conferences#AdvancesinComputerChess "Conferences") conferences
- to strengthen ties and to promote cooperation between computer-game [researchers](Category:Researcher "Category:Researcher")
- to introduce computer [games](Games "Games") to the games world
...
- Programmers Representative: [Mark Lefler](Mark_Lefler "Mark Lefler")
...
|
| --- | --- | --- | --- |
| [Ben Mittman](Ben_Mittman "Ben Mittman") | [ICCA](ICCA "ICCA") |  1977
|  1983
|
...
|  1992
|
| [Tony Marsland](Tony_Marsland "Tony Marsland") |  |  1992
|  1999
|
| [David Levy](David_Levy "David Levy") | [ICCA](ICCA "ICCA") |  1999
|  2002
|
| [David Levy](David_Levy "David Levy") | ICGA |  2002
|  2019
|
| [Jonathan Schaeffer](Jonathan_Schaeffer "Jonathan Schaeffer") |  |  2019
|  |
...
- [World Chess Software Championship](World_Chess_Software_Championship "World Chess Software Championship") since 2010
- [World Computer Chess Championship](World_Computer_Chess_Championship "World Computer Chess Championship")

[Tournament Rules](ICGA_Tournament_Rules "ICGA Tournament Rules")

- [World Microcomputer Chess Championship](World_Microcomputer_Chess_Championship "World Microcomputer Chess Championship") until 2001
...
- [ICGA: Chess Endgames](https://icga.org/icga/games/chess/endgames.php) compiled by [Guy Haworth](Guy_Haworth "Guy Haworth") and colleagues » [Endgame Tablebases](Endgame_Tablebases "Endgame Tablebases")
- [ICGA: Lines of Action](http://icga.leidenuniv.nl/icga/games/Loa/) by [Mark Winands](Mark_Winands "Mark Winands") » [Lines of Action](Lines_of_Action "Lines of Action")
- [ICGA: Losing Chess](http://icga.leidenuniv.nl/icga/games/losingchess/) by [Guy Haworth](Guy_Haworth "Guy Haworth")
- [ICGA: Roshambo](http://icga.leidenuniv.nl/icga/games/roshambo/) by [Guy Haworth](Guy_Haworth "Guy Haworth")
...
- [Yoji Ojima](index.php?title=Yoji_Ojima&action=edit&redlink=1 "Yoji Ojima (page does not exist)"), [Hideki Kato](Hideki_Kato "Hideki Kato") (**2012**). [Go](Go "Go") progam [Zen](https://www.game-ai-forum.org/icga-tournaments/program.php?id=594), that beat a 9 dan professional player ([Takemiya Masaki](https://en.wikipedia.org/wiki/Masaki_Takemiya)) in a 19x19 Go game with 4 stones of handicap on March 17, 2012.
- [Abdallah Saffidine](Abdallah_Saffidine "Abdallah Saffidine") (**2013**). *Solving Games and All That*. Ph.D. thesis, [Université Paris-Dauphine](University_of_Paris#9 "University of Paris"), advisor [Tristan Cazenave](Tristan_Cazenave "Tristan Cazenave"), [pdf](http://cgi.cse.unsw.edu.au/~abdallahs/Papers/2013/Solving%20Games%20and%20All%20That.pdf)
- [Gerd Isenberg](Gerd_Isenberg "Gerd Isenberg"), [Mark Lefler](Mark_Lefler "Mark Lefler") (**2014**). *[The Chess Programming Wiki.](Home "Home")*. (Thank you)

## ICGA Journal Awards

In 1992, a novel [Award](Template:ICGA_Journal_Awards "Template:ICGA Journal Awards") was instituted by the [ICCA](ICCA "ICCA"), the *ICCA Journal Award*. The Award is to be adjudicated annually to a first-time author for the best article in the [ICCA/ICGA Journal](ICGA_Journal "ICGA Journal") in the year under consideration.
...
- [Would the ICGA have accepted today's NNUE engines?](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=77639) by Madeleine Birchfield, [CCC](CCC "CCC"), July 05, 2021 » [NNUE](NNUE "NNUE")
