...
title: Joel Veness
---
**[Home](Home "Home") \* [People](People "People") \* Joel Veness**



 [](http://jveness.info/about_me/default.html) Joel Veness <a id="cite-note-1" href="#cite-ref-1">[1]</a> 
**Joel Veness**,  

an Australian games programmer, mathematician and computer scientist with a Ph.D. from [University of New South Wales](https://en.wikipedia.org/wiki/University_of_New_South_Wales) (UNSW). He spent two years at the [University of Alberta](University_of_Alberta "University of Alberta") as a postdoc under [Michael Bowling](Michael_Bowling "Michael Bowling"), and now works in the UK as research scientist at [Google](index.php?title=Google&action=edit&redlink=1 "Google (page does not exist)") [DeepMind](index.php?title=DeepMind&action=edit&redlink=1 "DeepMind (page does not exist)") <a id="cite-note-2" href="#cite-ref-2">[2]</a>. Joel is author of the chess engine [Bodo](Bodo "Bodo") <a id="cite-note-3" href="#cite-ref-3">[3]</a>, written in [C](C "C") and later [C++](Cpp "Cpp") <a id="cite-note-4" href="#cite-ref-4">[4]</a>. Joel Veness’ chess program [Meep](Meep "Meep") based on Bodo is one of the first master-level programs with an evaluation function that was learned entirely from self-play, by [bootstrapping](Meep#BootStrap "Meep") from deep searches <a id="cite-note-5" href="#cite-ref-5">[5]</a> . 
...
* Joel Veness (**2006**). *Expectimax Enhancements for Stochastic Game Players*. BSc-Thesis, [pdf](http://jveness.info/publications/thesis.pdf)
* Joel Veness, [Alan Blair](Alan_Blair "Alan Blair") (**2007**). *Effective Use of Transposition Tables in Stochastic Game Tree Search*. IEEE Symposium on Computational Intelligence and Games, [pdf](http://jveness.info/publications/cig2007%20-%20effective%20use%20of%20transposition%20tables%20in%20stochastic%20game%20tree%20search.pdf)
* Joel Veness, [David Silver](David_Silver "David Silver"), [William Uther](William_Uther "William Uther"), [Alan Blair](Alan_Blair "Alan Blair") (**2009**). *[Bootstrapping from Game Tree Search](http://papers.nips.cc/paper/3722-bootstrapping-from-game-tree-search)*. [pdf](http://jveness.info/publications/nips2009%20-%20bootstrapping%20from%20game%20tree%20search.pdf) <a id="cite-note-8" href="#cite-ref-8">[8]</a>, [video presentation](http://videolectures.net/nips09_veness_bfg/)
* Joel Veness, [Kee Siong Ng](index.php?title=Kee_Siong_Ng&action=edit&redlink=1 "Kee Siong Ng (page does not exist)"), [Marcus Hutter](Marcus_Hutter "Marcus Hutter"), [David Silver](David_Silver "David Silver") (**2009**). *A Monte Carlo AIXI Approximation*, [pdf](http://jveness.info/publications/arXive2009%20-%20a%20monte%20carlo%20aixi%20approximation.pdf)


### 2010 ...


* Joel Veness, [Kee Siong Ng](index.php?title=Kee_Siong_Ng&action=edit&redlink=1 "Kee Siong Ng (page does not exist)"), [Marcus Hutter](Marcus_Hutter "Marcus Hutter"), [David Silver](David_Silver "David Silver") (**2010**). *Reinforcement Learning via AIXI Approximation*. Association for the Advancement of Artificial Intelligence (AAAI), [pdf](http://jveness.info/publications/veness_rl_via_aixi_approx.pdf)
* Joel Veness (**2011**). *Approximate Universal Artificial Intelligence and Self-Play Learning for Games*. Ph.D. thesis, [University of New South Wales](https://en.wikipedia.org/wiki/University_of_New_South_Wales), supervisors: [Kee Siong Ng](index.php?title=Kee_Siong_Ng&action=edit&redlink=1 "Kee Siong Ng (page does not exist)"), [Marcus Hutter](Marcus_Hutter "Marcus Hutter"), [Alan Blair](Alan_Blair "Alan Blair"), [William Uther](William_Uther "William Uther"), [John Lloyd](index.php?title=John_Lloyd&action=edit&redlink=1 "John Lloyd (page does not exist)"); [pdf](http://jveness.info/publications/veness_phd_thesis_final.pdf)
* Joel Veness, [Kee Siong Ng](index.php?title=Kee_Siong_Ng&action=edit&redlink=1 "Kee Siong Ng (page does not exist)"), [Marcus Hutter](Marcus_Hutter "Marcus Hutter"), [William Uther](William_Uther "William Uther") , [David Silver](David_Silver "David Silver") (**2011**). *A Monte-Carlo AIXI Approximation*. [JAIR](https://en.wikipedia.org/wiki/Journal_of_Artificial_Intelligence_Research), Vol. 40, [pdf](http://www.aaai.org/Papers/JAIR/Vol40/JAIR-4004.pdf)
* Joel Veness, [Marc Lanctot](Marc_Lanctot "Marc Lanctot"), [Michael Bowling](Michael_Bowling "Michael Bowling") (**2011**). *Variance Reduction in Monte-Carlo Tree Search*. [NIPS](http://papers.nips.cc/book/advances-in-neural-information-processing-systems-24-2011), [pdf](http://papers.nips.cc/paper/4288-variance-reduction-in-monte-carlo-tree-search.pdf)
* [Marc Lanctot](Marc_Lanctot "Marc Lanctot"), [Abdallah Saffidine](Abdallah_Saffidine "Abdallah Saffidine"), Joel Veness, [Christopher Archibald](index.php?title=Christopher_Archibald&action=edit&redlink=1 "Christopher Archibald (page does not exist)") (**2012**). *Sparse Sampling for Adversarial Games*. [ECAI CGW 2012](index.php?title=ECAI_CGW_2012&action=edit&redlink=1 "ECAI CGW 2012 (page does not exist)")
...
* [Extracting bits from a BitBoard...](https://www.stmintz.com/ccc/index.php?id=265543) by Joel Veness, [CCC](CCC "CCC"), November 17, 2002 » [BitScan](BitScan "BitScan")
* [Measuring NPS...](https://www.stmintz.com/ccc/index.php?id=265653) by Joel Veness, [CCC](CCC "CCC"), November 17, 2002 » [Nodes per Second](Nodes_per_Second "Nodes per Second")
* [quiescent nodes, and history heuristic...](https://www.stmintz.com/ccc/index.php?id=280447) by Joel Veness, [CCC](CCC "CCC"), January 30, 2003 » [Quiescent Node](Quiescent_Node "Quiescent Node"), [History Heuristic](History_Heuristic "History Heuristic")
* [Your program is a ...](https://www.stmintz.com/ccc/index.php?id=324392) by Joel Veness, [CCC](CCC "CCC"), October 29, 2003
* [Re: CCT6: Rybka /Bodo ???](https://www.stmintz.com/ccc/index.php?id=345103) by Joel Veness, [CCC](CCC "CCC"), January 26, 2004 » [CCT6](CCT6 "CCT6"), [Rybka](Rybka "Rybka"), [Bodo](Bodo "Bodo")
* [Bodo @ CCT6....day 1....](https://www.stmintz.com/ccc/index.php?id=346744) by Joel Veness, [CCC](CCC "CCC"), February 03, 2004


### 2005 ...


* [programmers or people with online engines: arena with ICC](https://www.stmintz.com/ccc/index.php?id=416748) by Joel Veness, [CCC](CCC "CCC"), March 14, 2005 » [Arena](Arena "Arena"), [Bodo](Bodo "Bodo")
* [Re: BODO new OZ champion](https://www.stmintz.com/ccc/index.php?id=437047) by Joel Veness, [CCC](CCC "CCC"), July 17, 2005 » [NC3 2005](NC3_2005 "NC3 2005")


## External Links


* [Homepage of Joel Veness](http://jveness.info/about_me/default.html)
* [Veness, Joel](http://www.computer-go.info/db/operson.php?a=Veness%2C+Joel) from [computer-go.info](http://www.computer-go.info/)
* [Bootstrapping from Game Tree Search](http://videolectures.net/nips09_veness_bfg/), video presentation by Joel Veness, from [VideoLectures - exchange ideas & share knowledge](http://videolectures.net/), December 2009
* [Enabling Continual Learning in Neural Networks](https://deepmind.com/blog/enabling-continual-learning-in-neural-networks/) by [James Kirkpatrick](index.php?title=James_Kirkpatrick&action=edit&redlink=1 "James Kirkpatrick (page does not exist)"), Joel Veness et al., [DeepMind](index.php?title=DeepMind&action=edit&redlink=1 "DeepMind (page does not exist)"), March 13, 2017 » [Deep Learning](Deep_Learning "Deep Learning"), [Neural Networks](Neural_Networks "Neural Networks")
