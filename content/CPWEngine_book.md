---
title: CPWEngine book
---
**[Home](Home "Home") * [Engines](Engines "Engines") * [CPW-Engine](CPW-Engine "CPW-Engine") * Book**

This is the [opening book](Opening_Book "Opening Book") module of the CPW - Engine.Is responsibilities are :
...
- choosing the opening move out of possible alternatives(either completely [randomly](Pseudorandom_Number_Generator "Pseudorandom Number Generator") or based on frequency)
