...
title: Laurent Sifre
---
**[Home](Home "Home") \* [People](People "People") \* Laurent Sifre**



 [](http://www.cmap.polytechnique.fr/~sifre/) Laurent Sifre <a id="cite-note-1" href="#cite-ref-1">[1]</a> 
**Laurent Sifre**,  

 a French mathematician, computer scientist, and senior research scientist at [Google](index.php?title=Google&action=edit&redlink=1 "Google (page does not exist)") [DeepMind](index.php?title=DeepMind&action=edit&redlink=1 "DeepMind (page does not exist)"), involved in the [AlphaGo](index.php?title=AlphaGo&action=edit&redlink=1 "AlphaGo (page does not exist)") and [AlphaZero](AlphaZero "AlphaZero") projects mastering the games of [Go](Go "Go"), [chess](Chess "Chess") and [Shogi](Shogi "Shogi"). He holds a Ph.D. in [applied mathematics](https://en.wikipedia.org/wiki/Applied_mathematics) from [École Polytechnique](https://en.wikipedia.org/wiki/%C3%89cole_Polytechnique) under [Stéphane Mallat](Mathematician#SMallat "Mathematician") <a id="cite-note-2" href="#cite-ref-2">[2]</a>, where his research focused on the design of invariant image representations based on the [scattering transforms](https://en.wikipedia.org/wiki/Inverse_scattering_transform). Applications include [texture](https://en.wikipedia.org/wiki/Texture), and [image classification](https://en.wikipedia.org/wiki/Contextual_image_classification) <a id="cite-note-3" href="#cite-ref-3">[3]</a>. 
...
* [Laurent Sifre](http://www.cmap.polytechnique.fr/~sifre/)
* [Laurent Sifre | LinkedIn](https://www.linkedin.com/in/sifre/)
* [Laurent Sifre - Google Scholar Citations](https://scholar.google.com/citations?user=0kVh58wAAAAJ&hl=en)


## References


1. <a id="cite-ref-1" href="#cite-note-1">[1]</a> [Laurent Sifre](http://www.cmap.polytechnique.fr/~sifre/)
2. <a id="cite-ref-2" href="#cite-note-2">[2]</a> Laurent Sifre (**2014**). *Rigid-Motion Scattering for Image Classification*. Ph.D. thesis, [École Polytechnique](https://en.wikipedia.org/wiki/%C3%89cole_Polytechnique), supervisor [Stéphane Mallat](Mathematician#SMallat "Mathematician"), [pdf](http://www.di.ens.fr/data/publications/papers/phd_sifre.pdf)
3. <a id="cite-ref-3" href="#cite-note-3">[3]</a> [Laurent Sifre](http://www.cmap.polytechnique.fr/~sifre/)
4. <a id="cite-ref-4" href="#cite-note-4">[4]</a> [Publications | DeepMind](https://deepmind.com/research/publications/)
5. <a id="cite-ref-5" href="#cite-note-5">[5]</a> [Alpha Zero](http://www.open-chess.org/viewtopic.php?f=5&t=3153) by [BB+](Mark_Watkins "Mark Watkins"), [OpenChess Forum](Computer_Chess_Forums "Computer Chess Forums"), December 06, 2017
