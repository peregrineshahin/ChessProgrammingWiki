...
* [Stephen C. Kleene](Mathematician#SCKleene "Mathematician") (**1951**) *Representation of Events in Nerve Nets and Finite Automata*. RM-704, [RAND paper](https://en.wikipedia.org/wiki/RAND_Corporation), [pdf](http://www.rand.org/content/dam/rand/pubs/research_memoranda/2008/RM704.pdf), reprinted in
 ...
 [Claude Shannon](Claude_Shannon "Claude Shannon"), [John McCarthy](John_McCarthy "John McCarthy") (eds.) (**1956**). *Automata Studies*. [Annals of Mathematics Studies](https://www.wikidata.org/wiki/Q15763006), No. 34
...
* [Jean-Yves Audibert](Jean-Yves_Audibert "Jean-Yves Audibert") (**2004**). *PAC-Bayesian Statistical Learning Theory*. Ph.D. thesis, [Université Paris VI](https://en.wikipedia.org/wiki/Pierre_and_Marie_Curie_University), [pdf](http://certis.enpc.fr/~audibert/Mes%20articles/PhDthesis.pdf), [slides as pdf](http://certis.enpc.fr/~audibert/Mes%20articles/audibert_PhD_defense.pdf)
...
* [Alejandro González Romero](Alejandro_Gonz%C3%A1lez_Romero "Alejandro González Romero"), [René Alquézar](http://www.lsi.upc.edu/~alquezar/) (**2004**). *[Learning Through the KRKa2 Chess Ending](http://www.springerlink.com/content/rbbxnr865xyjbf4c/)*. [CIARP 2004](http://www.informatik.uni-trier.de/~ley/db/conf/ciarp/ciarp2004.html)
* [Daniel Osman](index.php?title=Daniel_Osman&action=edit&redlink=1 "Daniel Osman (page does not exist)"), [Jacek Mańdziuk](Jacek_Ma%C5%84dziuk "Jacek Mańdziuk") (**2004**). *Comparison of TDLeaf and TD learning in Game Playing Domain*. [11. ICONIP](http://www.informatik.uni-trier.de/~ley/db/conf/iconip/iconip2004.html#OsmanM04), [pdf](http://www.mini.pw.edu.pl/~mandziuk/PRACE/ICONIP04.pdf)
...
* [Dave Gomboc](Dave_Gomboc "Dave Gomboc"), [Michael Buro](Michael_Buro "Michael Buro"), [Tony Marsland](Tony_Marsland "Tony Marsland") (**2005**). *Tuning evaluation functions by maximizing concordance* Theoretical Computer Science, Volume 349, Issue 2, pp. 202-229, [pdf](http://www.cs.ualberta.ca/%7Emburo/ps/tcs-learn.pdf)
...
* [David J. Stracuzzi](index.php?title=David_J._Stracuzzi&action=edit&redlink=1 "David J. Stracuzzi (page does not exist)") (**2005**). *Scalable learning in many layers*. [University of Massachusetts Amherst](https://en.wikipedia.org/wiki/University_of_Massachusetts_Amherst), TR-05-02, [pdf](http://www.stracuzzi.info/david/manuscripts/tr-05-02.pdf)
...
* [Sverrir Sigmundarson](http://nemendur.ru.is/sverrirs01/), [Yngvi Björnsson](Yngvi_Bj%C3%B6rnsson "Yngvi Björnsson"). (**2006**) *Value Back-Propagation vs. Backtracking in Real-Time Search.* In Proceedings of the National Conference on Artificial Intelligence ([AAAI](AAAI "AAAI")), Workshop on Learning For Search, pp. 136–141, AAAI Press, Boston, Massachusetts, USA, July 2006. [pdf](http://www.ru.is/faculty/yngvi/pdf/SigmundarsonB06b.pdf)
* [Sylvain Gelly](Sylvain_Gelly "Sylvain Gelly"), [Olivier Teytaud](Olivier_Teytaud "Olivier Teytaud"), [Nicolas Bredèche](index.php?title=Nicolas_Bred%C3%A8che&action=edit&redlink=1 "Nicolas Bredèche (page does not exist)"), [Marc Schoenauer](Marc_Schoenauer "Marc Schoenauer") (**2006**). *[Universal Consistency and Bloat in GP](http://eprints.pascal-network.org/archive/00002724/). Some theoretical considerations about Genetic Programming from a Statistical Learning Theory viewpoint.* [pdf](http://eprints.pascal-network.org/archive/00002724/01/riabloat.pdf)
* [Sylvain Gelly](Sylvain_Gelly "Sylvain Gelly"), [Jérémie Mary](J%C3%A9r%C3%A9mie_Mary "Jérémie Mary"), [Olivier Teytaud](Olivier_Teytaud "Olivier Teytaud") (**2006**). *Learning for stochastic dynamic programming*. [pdf](http://www.lri.fr/%7Egelly/paper/lfordp.pdf)
* [Olivier Teytaud](Olivier_Teytaud "Olivier Teytaud"), [Sylvain Gelly](Sylvain_Gelly "Sylvain Gelly") (**2006**). *General lower bounds for evolutionary algorithms.* [pdf](http://www.lri.fr/%7Egelly/paper/lblong.pdf)
...
* [Tom Mitchell](Tom_Mitchell "Tom Mitchell") (**2006**). *The Discipline of Machine Learning*. CMU-ML-06-108, [Carnegie Mellon University](Carnegie_Mellon_University "Carnegie Mellon University"), [pdf](http://www.cs.cmu.edu/%7Etom/pubs/MachineLearning.pdf)
* [Tom Mitchell](Tom_Mitchell "Tom Mitchell") (**2006**). *Human and Machine Learning*. [Carnegie Mellon University](Carnegie_Mellon_University "Carnegie Mellon University"), [slides as pdf](http://www.cs.cmu.edu/%7Etom/pubs/HumanMachineLearning_11_2006_web.pdf)
* [Jeff Rollason](Jeff_Rollason "Jeff Rollason") (**2006**). *[Playing Stronger by learning](http://www.aifactory.co.uk/newsletter/2005_04_stronger-by-learning.htm)*. [AI Factory](AI_Factory "AI Factory"), Winter 2006
* [Simon Lucas](Simon_Lucas "Simon Lucas"), [Thomas Philip Runarsson](Thomas_Philip_Runarsson "Thomas Philip Runarsson") (**2006**). *[Temporal Difference Learning versus Co-Evolution for Acquiring Othello Position Evaluation](http://scholar.google.is/citations?view_op=view_citation&hl=en&user=4eWdc_sAAAAJ&citation_for_view=4eWdc_sAAAAJ:qjMakFHDy7sC)*. [IEEE Symposium on Computational Intelligence and Games](IEEE#CIG "IEEE") » [Othello](Othello "Othello")
...
* [Sylvain Gelly](Sylvain_Gelly "Sylvain Gelly"), [Olivier Teytaud](Olivier_Teytaud "Olivier Teytaud"), [Jérémie Mary](J%C3%A9r%C3%A9mie_Mary "Jérémie Mary") (**2007**). *Active learning in regression, with application to stochastic dynamic programming*. ICINCO and CAP, [pdf](http://www.grappa.univ-lille3.fr/~mary/paper/ldsfordp.pdf)
...
* [Igor Kononenko](Igor_Kononenko "Igor Kononenko"), [Matjaž Kukar](http://www.informatik.uni-trier.de/%7Eley/db/indices/a-tree/k/Kukar:Matjaz.html) (**2007**). *[Machine Learning and Data Mining: Introduction to Principles and Algorithms](http://mldmbook.fri.uni-lj.si/)*.
...
* [Joaquin Vanschoren](index.php?title=Joaquin_Vanschoren&action=edit&redlink=1 "Joaquin Vanschoren (page does not exist)"), [Bernhard Pfahringer](Bernhard_Pfahringer "Bernhard Pfahringer"), [Geoffrey Holmes](index.php?title=Geoffrey_Holmes&action=edit&redlink=1 "Geoffrey Holmes (page does not exist)") (**2008**). *Learning from the Past with Experiment Databases*. [PRICAI 2008](http://www.informatik.uni-trier.de/~ley/db/conf/pricai/pricai2008.html#VanschorenPH08), [pdf](https://lirias.kuleuven.be/bitstream/123456789/196273/1/pricai08.pdf)
...
* [Omid David](Eli_David "Eli David") (**2009**). *Genetic Algorithms Based Learning for Evolving Intelligent Organisms*. Ph.D. Thesis [[23]](#cite_note-23)
...
* [Trevor Hastie](Mathematician#THastie "Mathematician"), [Robert Tibshirani](Mathematician#RTibshirani "Mathematician"), [Jerome Friedman](https://en.wikipedia.org/wiki/Jerome_H._Friedman) (**2009**). *[The Elements of Statistical Learning: Data Mining, Inference, and Prediction](http://www.springer.com/book/9780387848570)*. Second Edition, [Springer](https://de.wikipedia.org/wiki/Springer_Science%2BBusiness_Media)
* [Mark A. Hall](https://dblp.uni-trier.de/pers/hd/h/Hall:Mark_A=), [Eibe Frank](https://dblp.uni-trier.de/pers/hd/f/Frank:Eibe), [Geoffrey Holmes](index.php?title=Geoffrey_Holmes&action=edit&redlink=1 "Geoffrey Holmes (page does not exist)"), [Bernhard Pfahringer](Bernhard_Pfahringer "Bernhard Pfahringer"), [Peter Reutemann](https://dblp.uni-trier.de/pers/hd/r/Reutemann:Peter), [Ian H. Witten](Ian_H._Witten "Ian H. Witten") (**2009**). *The WEKA data mining software: an update*. [SIGKDD Explorations](https://dblp.uni-trier.de/db/journals/sigkdd/sigkdd11.html), Vol. 11, No. 1, [pdf](https://www.kdd.org/exploration_files/p2V11n1.pdf) [[26]](#cite_note-26)


### 2010 ...


* [Johannes Fürnkranz](Johannes_F%C3%BCrnkranz "Johannes Fürnkranz"), [Eyke Hüllermeier](https://de.wikipedia.org/wiki/Eyke_H%C3%BCllermeier) (eds.) (**2010**). *[Preference Learning](https://link.springer.com/book/10.1007/978-3-642-14125-6)*. [Springer](https://en.wikipedia.org/wiki/Springer_Science%2BBusiness_Media)
...
* [Jacek Mańdziuk](Jacek_Ma%C5%84dziuk "Jacek Mańdziuk") (**2010**). *[Knowledge-Free and Learning-Based Methods in Intelligent Game Playing](http://link.springer.com/book/10.1007%2F978-3-642-11678-0)*. [Studies in Computational Intelligence](http://link.springer.com/bookseries/7092), Vol. 276, [Springer](https://en.wikipedia.org/wiki/Springer_Science%2BBusiness_Media)
...
* [Omid David](Eli_David "Eli David"), [Nathan S. Netanyahu](Nathan_S._Netanyahu "Nathan S. Netanyahu"), Yoav Rosenberg, Moshe Shimoni (**2010**). *Genetic Algorithms for Automatic Classification of Moving Objects*. [ACM](ACM "ACM") Genetic and Evolutionary Computation Conference ([GECCO '10](http://www.sigevo.org/gecco-2010/)), [Portland, OR](https://en.wikipedia.org/wiki/Portland,_Oregon), [pdf](http://www.omiddavid.com/pubs/object-classification.pdf)
...
* [Jean-Yves Audibert](Jean-Yves_Audibert "Jean-Yves Audibert") (**2010**). *PAC-Bayesian aggregation and multi-armed bandits*. Habilitation thesis, [Université Paris Est](http://fr.wikipedia.org/wiki/Universit%C3%A9_Paris-Est), [pdf](http://certis.enpc.fr/~audibert/Mes%20articles/hdr.pdf), [slides as pdf](http://certis.enpc.fr/~audibert/Mes%20articles/hdrSlides.pdf)
...
* [Karol Walędzik](http://www.informatik.uni-trier.de/~ley/db/indices/a-tree/w/Waledzik:Karol.html), [Jacek Mańdziuk](Jacek_Ma%C5%84dziuk "Jacek Mańdziuk") (**2010**). *The Layered Learning method and its Application to Generation of Evaluation Functions for the Game of Checkers*. [11. PPSN](http://www.informatik.uni-trier.de/~ley/db/conf/ppsn/ppsn2010-2.html#WaledzikM10), [pdf](http://www.mini.pw.edu.pl/~mandziuk/PRACE/PPSN10.pdf) » [Checkers](Checkers "Checkers")
* [Krzysztof Krawiec](Krzysztof_Krawiec "Krzysztof Krawiec"), [Marcin Szubert](Marcin_Szubert "Marcin Szubert") (**2010**). *[Coevolutionary Temporal Difference Learning for small-board Go](http://ieeexplore.ieee.org/xpl/articleDetails.jsp?arnumber=5586054)*. [IEEE Congress on Evolutionary Computation](IEEE#EC "IEEE") » [Go](Go "Go")
...
* [Peter Dayan](Peter_Dayan "Peter Dayan") (**2012**). *How to set the switches on this thing*. [Current Opinion in Neurobiology](http://www.sciencedirect.com/science/journal/09594388), Vol. 22, [pdf](http://www.gatsby.ucl.ac.uk/~dayan/papers/dayanswitch2012.pdf)
...
* [Marcin Szubert](Marcin_Szubert "Marcin Szubert"), [Wojciech Jaśkowski](Wojciech_Ja%C5%9Bkowski "Wojciech Jaśkowski") (**2014**). *Temporal Difference Learning of N-Tuple Networks for the Game 2048*. [IEEE Conference on Computational Intelligence and Games](IEEE#CIG "IEEE"), [pdf](http://www.cs.put.poznan.pl/mszubert/pub/szubert2014cig.pdf) [[30]](#cite_note-30)
...
* [Wojciech Jaśkowski](Wojciech_Ja%C5%9Bkowski "Wojciech Jaśkowski") (**2014**). *Systematic n-Tuple Networks for Othello Position Evaluation*. [ICGA Journal, Vol. 37, No. 2](ICGA_Journal#37_2 "ICGA Journal"), [preprint as pdf](http://www.cs.put.poznan.pl/wjaskowski/pub/papers/jaskowski2014ICGAsystematic.pdf) » [Othello](Othello "Othello")
* [Christopher Clark](Christopher_Clark "Christopher Clark"), [Amos Storkey](Amos_Storkey "Amos Storkey") (**2014**). *Teaching Deep Convolutional Neural Networks to Play Go*. [arXiv:1412.3409](http://arxiv.org/abs/1412.3409) » [Neural Networks](Neural_Networks "Neural Networks") [[31]](#cite_note-31) [[32]](#cite_note-32) [[33]](#cite_note-33)
* [Chris J. Maddison](Chris_J._Maddison "Chris J. Maddison"), [Aja Huang](Shih-Chieh_Huang "Shih-Chieh Huang"), [Ilya Sutskever](Ilya_Sutskever "Ilya Sutskever"), [David Silver](David_Silver "David Silver") (**2014**). *Move Evaluation in Go Using Deep Convolutional Neural Networks*. [arXiv:1412.6564v1](http://arxiv.org/abs/1412.6564v1)
* [I-Chen Wu](I-Chen_Wu "I-Chen Wu"), [Kun-Hao Yeh](Kun-Hao_Yeh "Kun-Hao Yeh"), [Chao-Chin Liang](Chao-Chin_Liang "Chao-Chin Liang"), [Chia-Chuan Chang](index.php?title=Chia-Chuan_Chang&action=edit&redlink=1 "Chia-Chuan Chang (page does not exist)"), [Han Chiang](index.php?title=Han_Chiang&action=edit&redlink=1 "Han Chiang (page does not exist)") (**2014**). *Multi-Stage Temporal Difference Learning for 2048*. [TAAI 2014](index.php?title=TAAI_2014&action=edit&redlink=1 "TAAI 2014 (page does not exist)"), best paper award [[34]](#cite_note-34)
* [Ronald Ortner](Mathematician#ROrtner "Mathematician"), [Daniil Ryabko](Mathematician#DRyabko "Mathematician"), [Peter Auer](Peter_Auer "Peter Auer"), [Rémi Munos](R%C3%A9mi_Munos "Rémi Munos") (**2014**). *Regret bounds for restless Markov bandits*. [Theoretical Computer Science](https://en.wikipedia.org/wiki/Theoretical_Computer_Science_%28journal%29) 558, [pdf](http://daniil.ryabko.net/mabajr.pdf)
...
* [Yuichiro Sato](index.php?title=Yuichiro_Sato&action=edit&redlink=1 "Yuichiro Sato (page does not exist)"), [Hiroyuki Iida](Hiroyuki_Iida "Hiroyuki Iida"), [Jaap van den Herik](Jaap_van_den_Herik "Jaap van den Herik") (**2015**). *Transfer Learning by Inductive Logic Programming*. [Advances in Computer Games 14](Advances_in_Computer_Games_14 "Advances in Computer Games 14")
...
* [Tom Schaul](index.php?title=Tom_Schaul&action=edit&redlink=1 "Tom Schaul (page does not exist)"), [John Quan](index.php?title=John_Quan&action=edit&redlink=1 "John Quan (page does not exist)"), [Ioannis Antonoglou](Ioannis_Antonoglou "Ioannis Antonoglou"), [David Silver](David_Silver "David Silver") (**2015**). *Prioritized Experience Replay*. [arXiv:1511.05952](http://arxiv.org/abs/1511.05952)
* [Miroslav Kubat](Miroslav_Kubat "Miroslav Kubat") (**2015**). *[An Introduction to Machine Learning](https://www.springer.com/us/book/9783319348865#otherversion=9783319200095)*. [Springer](https://en.wikipedia.org/wiki/Springer_Science%2BBusiness_Media)
...
* [Jialin Liu](index.php?title=Jialin_Liu&action=edit&redlink=1 "Jialin Liu (page does not exist)"), [Olivier Teytaud](Olivier_Teytaud "Olivier Teytaud"), [Tristan Cazenave](Tristan_Cazenave "Tristan Cazenave") (**2016**). *Fast seed-learning algorithms for games*. [CG 2016](CG_2016 "CG 2016")
* [Omid E. David](Eli_David "Eli David"), [Nathan S. Netanyahu](Nathan_S._Netanyahu "Nathan S. Netanyahu"), [Lior Wolf](index.php?title=Lior_Wolf&action=edit&redlink=1 "Lior Wolf (page does not exist)") (**2016**). *[DeepChess: End-to-End Deep Neural Network for Automatic Learning in Chess](http://link.springer.com/chapter/10.1007%2F978-3-319-44781-0_11)*. [ICAAN 2016](http://icann2016.org/), [Lecture Notes in Computer Science](https://en.wikipedia.org/wiki/Lecture_Notes_in_Computer_Science), Vol. 9887, [Springer](https://en.wikipedia.org/wiki/Springer_Science%2BBusiness_Media), [pdf preprint](http://www.cs.tau.ac.il/~wolf/papers/deepchess.pdf) » [DeepChess](index.php?title=DeepChess&action=edit&redlink=1 "DeepChess (page does not exist)") [[35]](#cite_note-35) [[36]](#cite_note-36)
...
* [Stephen Muggleton](Stephen_Muggleton "Stephen Muggleton") (**2017**). *Meta-Interpretive Learning: Achievements and Challenges*. Invited Paper, [RuleML+RR 2017](https://dblp.uni-trier.de/db/conf/ruleml/ruleml2017.html), [pdf](https://www.doc.ic.ac.uk/~shm/Papers/rulemlabs.pdf)
* [Muthuraman Chidambaram](index.php?title=Muthuraman_Chidambaram&action=edit&redlink=1 "Muthuraman Chidambaram (page does not exist)"), [Yanjun Qi](index.php?title=Yanjun_Qi&action=edit&redlink=1 "Yanjun Qi (page does not exist)") (**2017**). *Style Transfer Generative Adversarial Networks: Learning to Play Chess Differently*. [arXiv:1702.06762v1](https://arxiv.org/abs/1702.06762v1) [[37]](#cite_note-37) » [Neural Networks](Neural_Networks "Neural Networks")
...
* [Miroslav Kubat](Miroslav_Kubat "Miroslav Kubat") (**2017**). *[An Introduction to Machine Learning](https://www.springer.com/gp/book/9783319639123)*. Second Edition, [Springer](https://en.wikipedia.org/wiki/Springer_Science%2BBusiness_Media)
...
* [Arthur Guez](Arthur_Guez "Arthur Guez"), [Théophane Weber](index.php?title=Th%C3%A9ophane_Weber&action=edit&redlink=1 "Théophane Weber (page does not exist)"), [Ioannis Antonoglou](Ioannis_Antonoglou "Ioannis Antonoglou"), [Karen Simonyan](Karen_Simonyan "Karen Simonyan"), [Oriol Vinyals](index.php?title=Oriol_Vinyals&action=edit&redlink=1 "Oriol Vinyals (page does not exist)"), [Daan Wierstra](index.php?title=Daan_Wierstra&action=edit&redlink=1 "Daan Wierstra (page does not exist)"), [Rémi Munos](R%C3%A9mi_Munos "Rémi Munos"), [David Silver](David_Silver "David Silver") (**2018**). *Learning to Search with MCTSnets*. [arXiv:1802.04697](https://arxiv.org/abs/1802.04697) » [Monte-Carlo Tree Search](Monte-Carlo_Tree_Search "Monte-Carlo Tree Search")
...
* [Takeshi Ito](Takeshi_Ito "Takeshi Ito") (**2018**). *Game learning support system based on future position*. [CG 2018](CG_2018 "CG 2018"), [ICGA Journal, Vol. 40, No. 4](ICGA_Journal#40_4 "ICGA Journal")
...
* [Opponent specific learning...](https://www.stmintz.com/ccc/index.php?id=16136) by [Daniel Homan](Daniel_Homan "Daniel Homan"), [CCC](CCC "CCC"), March 26, 1998
...
* [Time to implement Learning](https://www.stmintz.com/ccc/index.php?id=351488) by [Tom Likens](Tom_Likens "Tom Likens"), [CCC](CCC "CCC"), February 26, 2004


### 2005 ...


* [RomiChess && learning or the emperor has no clothes](http://www.open-aurec.com/wbforum/viewtopic.php?f=4&t=4835) by [Michael Sherwin](Michael_Sherwin "Michael Sherwin"), [Winboard Programming Forum](Computer_Chess_Forums "Computer Chess Forums"), May 19, 2006
* [learning](http://www.talkchess.com/forum/viewtopic.php?t=19381) by Jim, [CCC](CCC "CCC"), February 03, 2008
* [Information on engines with learning capabilities](http://www.talkchess.com/forum/viewtopic.php?t=20549) by [Martin Thoresen](Martin_Thoresen "Martin Thoresen"), [CCC](CCC "CCC"), April 06, 2008
* [naive bayes classifier](http://www.talkchess.com/forum/viewtopic.php?t=29056) by [Don Dailey](Don_Dailey "Don Dailey"), [CCC](CCC "CCC"), July 21, 2009 [[40]](#cite_note-40)
...
* [Ban: Automatic Learning of Evaluation [...](http://www.open-chess.org/viewtopic.php?f=5&t=1954)] by [BB+](Mark_Watkins "Mark Watkins"), [OpenChess Forum](Computer_Chess_Forums "Computer Chess Forums"), May 10, 2012 [[41]](#cite_note-41)
* [Teaching Deep Convolutional Neural Networks to Play Go](http://computer-go.org/pipermail/computer-go/2014-December/007010.html) by [Hiroshi Yamashita](Hiroshi_Yamashita "Hiroshi Yamashita"), [The Computer-go Archives](http://computer-go.org/pipermail/computer-go/), December 14, 2014 [[42]](#cite_note-42)
* [Teaching Deep Convolutional Neural Networks to Play Go](http://www.talkchess.com/forum/viewtopic.php?t=54663) by [Michel Van den Bergh](Michel_Van_den_Bergh "Michel Van den Bergh"), [CCC](CCC "CCC"), December 16, 2014 [[43]](#cite_note-43)
...
* [A database for learning evaluation functions](http://www.talkchess.com/forum/viewtopic.php?t=61861) by [Álvaro Begué](%C3%81lvaro_Begu%C3%A9 "Álvaro Begué"), [CCC](CCC "CCC"), October 28, 2016 » [Automated Tuning](Automated_Tuning "Automated Tuning"), [Evaluation](Evaluation "Evaluation"), [Texel's Tuning Method](Texel%27s_Tuning_Method "Texel's Tuning Method")
* [Interesting article in "Nature" on Machine Learning](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=69536) by [Kai Laskos](Kai_Laskos "Kai Laskos"), [CCC](CCC "CCC"), January 09, 2019
* [A book on machine learning](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=72020) by Mehdi Amini, [CCC](CCC "CCC"), October 06, 2019
...
* [Classical conditioning from Wikipeadia](https://en.wikipedia.org/wiki/Classical_conditioning)
* [Learnable Evolution Model from Wikipedia](https://en.wikipedia.org/wiki/Learnable_Evolution_Model)
* [Monkey see Monkey do from Wikipeadia](https://en.wikipedia.org/wiki/Monkey_see,_monkey_do)
* [Observational learning from Wikipeadia](https://en.wikipedia.org/wiki/Observational_learning)
* [Rote learning from Wikipeadia](https://en.wikipedia.org/wiki/Rote_learning)


### Machine Learning


* [Machine learning from Wikipeadia](https://en.wikipedia.org/wiki/Machine_learning)
* [Machine Learning in Games](http://satirist.org/learn-game/) by [Jay Scott](Jay_Scott "Jay Scott")
* [Machine Learning](http://machine-learning.martinsewell.com/) by [Martin Sewell](http://www.martinsewell.com/)
* [List of machine learning concepts from Wikipedia](https://en.wikipedia.org/wiki/List_of_machine_learning_concepts)
* [Apprenticeship learning from Wikipedia](https://en.wikipedia.org/wiki/Apprenticeship_learning)
* [Automated machine learning from Wikipedia](https://en.wikipedia.org/wiki/Automated_machine_learning)
* [Data mining from Wikipeadia](https://en.wikipedia.org/wiki/Data_mining)
* [Ensemble learning from Wikipedia](https://en.wikipedia.org/wiki/Ensemble_learning)
	+ [Bootstrap aggregating from Wikipedia](https://en.wikipedia.org/wiki/Bootstrap_aggregating)
* [Explanation-based learning from Wikipedia](https://en.wikipedia.org/wiki/Explanation-based_learning)
* [Meta Learning from Wikipedia](https://en.wikipedia.org/wiki/Meta_learning_%28computer_science%29)
* [Online Machine Learning from Wikipedia](https://en.wikipedia.org/wiki/Online_machine_learning)
* [PAC Learning from Wikipedia](https://en.wikipedia.org/wiki/Probably_approximately_correct_learning)
...
* [Similarity learning from Wikipedia](https://en.wikipedia.org/wiki/Similarity_learning)
* [Universal Learning Machines - Optimal Universal AI](http://www.idsia.ch/~juergen/unilearn.html) by [Jürgen Schmidhuber](J%C3%BCrgen_Schmidhuber "Jürgen Schmidhuber")
* [UCI Machine Learning Repository](http://archive.ics.uci.edu/ml/) from [University of California, Irvine](https://en.wikipedia.org/wiki/University_of_California,_Irvine)
* [NMCS4All](https://csforallteachers.org/group/nmcs4all): Machine Learning by [David H. Ackley](Mathematician#DHAckley "Mathematician"), [YouTube](https://en.wikipedia.org/wiki/YouTube) Video
...
* [Artificial Intelligence II](http://www.cs.cf.ac.uk/Dave/AI2/AI_notes.html) by [Nikos Drakos](http://blogs.gartner.com/nikos_drakos/), Computer Based Learning Unit, [University of Leeds](https://en.wikipedia.org/wiki/University_of_Leeds)
 ...
 [Learning I](http://www.cs.cf.ac.uk/Dave/AI2/node130.html#SECTION000150000000000000000)
 [Learning II](http://www.cs.cf.ac.uk/Dave/AI2/node143.html#SECTION000160000000000000000)
* [AI Horizon: Machine Learning, Part I: Types of Learning Problems](http://www.aihorizon.com/essays/generalai/machine_learning.htm)
* [AI Horizon: Machine Learning, Part II: Supervised and Unsupervised Learning](http://www.aihorizon.com/essays/generalai/supervised_unsupervised_machine_learning.htm)
* [AI Horizon: Machine Learning, Part III: Testing Algorithms, and The "No Free Lunch Theorem"](http://www.aihorizon.com/essays/generalai/no_free_lunch_machine_learning.htm)


### Chess


* [UCI Machine Learning Repository: Chess (King-Rook vs. King-Pawn) Data Set](http://archive.ics.uci.edu/ml/datasets/Chess+%28King-Rook+vs.+King-Pawn%29) by [Alen Shapiro](Alen_Shapiro "Alen Shapiro")
...
* [Boosting (machine learning) from Wikipedia](https://en.wikipedia.org/wiki/Boosting_%28machine_learning%29)
	+ [AdaBoost from Wikipedia](https://en.wikipedia.org/wiki/AdaBoost)
...
* [Category: Unsupervised learning - Scholarpedia](http://www.scholarpedia.org/article/Category:Unsupervised_learning)


### Reinforcement Learning


* [Reinforcement Learning from Wikipeadia](https://en.wikipedia.org/wiki/Reinforcement_learning)
...
* [Q-learning from Wikipeadia](https://en.wikipedia.org/wiki/Q-learning)
...
* [TD-Gammon from Wikipeadi](https://en.wikipedia.org/wiki/TD-Gammon)
* [Td-gammon - Scholarpedia](http://www.scholarpedia.org/article/Td-gammon)
...
* [Statistical learning theory from Wikipedia](https://en.wikipedia.org/wiki/Statistical_learning_theory)
* [Statistical classification from Wikipedia](https://en.wikipedia.org/wiki/Statistical_classification)
	...
	+ [Probabilistic classification from Wikipedia](https://en.wikipedia.org/wiki/Probabilistic_classification)
* [Statistical mechanics from Wikipedia](https://en.wikipedia.org/wiki/Statistical_mechanics)
* [Bayesian network from Wikipedia](https://en.wikipedia.org/wiki/Bayesian_network)
* [Bayesian spam filtering from Wikipedia](https://en.wikipedia.org/wiki/Bayesian_spam_filtering)
* [Can a Bayesian spam filter play chess?](http://dbacl.sourceforge.net/spam_chess-1.html) by [Laird A. Breyer](http://www.lbreyer.com/)
* [Computational statistics from Wikipedia](https://en.wikipedia.org/wiki/Computational_statistics)
* [Cluster analysis from Wikipedia](https://en.wikipedia.org/wiki/Data_clustering)
* [Cross entropy from Wikipedia](https://en.wikipedia.org/wiki/Cross_entropy)
* [Dimensionality reduction from Wikipedia](https://en.wikipedia.org/wiki/Dimensionality_reduction)
* [Feature extraction from Wikipedia](https://en.wikipedia.org/wiki/Feature_extraction)
* [Feature selection from Wikipedia](https://en.wikipedia.org/wiki/Feature_selection)
...
* [Probability measure from Wikipedia](https://en.wikipedia.org/wiki/Probability_measure)
* [Probability space from Wikipedia](https://en.wikipedia.org/wiki/Probability_space)
...
* [Vapnik–Chervonenkis theory from Wikipedia](https://en.wikipedia.org/wiki/Vapnik%E2%80%93Chervonenkis_theory)
* [VC dimension from Wikipedia](https://en.wikipedia.org/wiki/VC_dimension)


### Markov Models


* [Markov model from Wikipedia](https://en.wikipedia.org/wiki/Markov_model)
* [Markov chain from Wikipedia](https://en.wikipedia.org/wiki/Markov_chain)
* [Hidden Markov model from Wikipedia](https://en.wikipedia.org/wiki/Hidden_Markov_model)
* [Markov decision process (MDP) from Wikipedia](https://en.wikipedia.org/wiki/Markov_decision_process)
* [Partially observable Markov decision process (POMDP) from Wikipedia](https://en.wikipedia.org/wiki/Partially_observable_Markov_decision_process)


### NNs


* [Introduction to Neural Networks](http://nic.schraudolph.org/teach/NNcourse/) by [Nicol N. Schraudolph](Nicol_N._Schraudolph "Nicol N. Schraudolph") and [Fred Cummins](http://scholar.google.com/citations?user=E-vg2zQAAAAJ&hl=en)
...
* [Dendrite from Wikipedia](https://en.wikipedia.org/wiki/Dendrite)
* [Hebbian theory from Wikipedia](https://en.wikipedia.org/wiki/Hebbian_theory)
* [Generalized Hebbian Algorithm from Wikipedia](https://en.wikipedia.org/wiki/Generalized_Hebbian_Algorithm)
* [Long-term potentiation from Wikipedia](https://en.wikipedia.org/wiki/Long-term_potentiation)
...
* [Neurotransmitter from Wikipedia](https://en.wikipedia.org/wiki/Neurotransmitter)
* [Synapse from Wikipedia](https://en.wikipedia.org/wiki/Synapse)
* [Synaptic plasticity from Wikipedia](https://en.wikipedia.org/wiki/Synaptic_plasticity)
...
* [Advanced Topics: RL](http://www0.cs.ucl.ac.uk/staff/d.silver/web/Teaching.html) by [David Silver](David_Silver "David Silver")
* [Learning From Data - Online Course (MOOC)](http://work.caltech.edu/telecourse.html) by [Yaser Abu-Mostafa](https://en.wikipedia.org/wiki/Yaser_Abu-Mostafa), [Caltech](https://en.wikipedia.org/wiki/California_Institute_of_Technology)
* [Machine Learning and Probabilistic Graphical Models: Course Materials](http://www.cedar.buffalo.edu/~srihari/CSE574/index.html) by [Sargur Srihari](https://en.wikipedia.org/wiki/Sargur_Srihari), [University at Buffalo](https://en.wikipedia.org/wiki/University_at_Buffalo)
...
* [Stanford Machine Learning](http://www.holehouse.org/mlclass/index.html) by [Andrew Ng](index.php?title=Andrew_Ng&action=edit&redlink=1 "Andrew Ng (page does not exist)")
* [Lecture 1](https://www.youtube.com/watch?v=UzxYlbK2c7E&list=PLA89DCFA6ADACE599&index=1) | [Machine Learning (Stanford)](https://www.youtube.com/view_play_list?p=A89DCFA6ADACE599) by [Andrew Ng](index.php?title=Andrew_Ng&action=edit&redlink=1 "Andrew Ng (page does not exist)"), [YouTube](https://en.wikipedia.org/wiki/YouTube) Video
...
1. [↑](#cite_ref-1) A depiction of the world's oldest continually operating university, the [University of Bologna](https://en.wikipedia.org/wiki/University_of_Bologna), Italy, by Laurentius de Voltolina, second half of 14th century, [Learning from Wikipedia](https://en.wikipedia.org/wiki/Learning)
2. [↑](#cite_ref-2) [Inductive learning vs Deductive learning](http://www.beatthegmat.com/inductive-learning-vs-deductive-learning-t36273.html)
3. [↑](#cite_ref-3) [David Slate](David_Slate "David Slate") (**1987**). *A Chess Program that uses its Transposition Table to Learn from Experience.* [ICCA Journal, Vol. 10, No. 2](ICGA_Journal#10_2 "ICGA Journal")
4. [↑](#cite_ref-4) [Robert Hyatt](Robert_Hyatt "Robert Hyatt") (**1999**). *[Book Learning - a Methodology to Tune an Opening Book Automatically](http://www.craftychess.com/hyatt/learning.html)*. [ICCA Journal, Vol. 22, No. 1](ICGA_Journal#22_1 "ICGA Journal")
5. [↑](#cite_ref-5) [Don Beal](Don_Beal "Don Beal"), [Martin C. Smith](Martin_C._Smith "Martin C. Smith") (**1997**). *Learning Piece Values Using Temporal Differences*. [ICCA Journal, Vol. 20, No. 3](ICGA_Journal#20_3 "ICGA Journal")
6. [↑](#cite_ref-6) [Don Beal](Don_Beal "Don Beal"), [Martin C. Smith](Martin_C._Smith "Martin C. Smith") (**1999**). *Learning Piece-Square Values using Temporal Differences.* [ICCA Journal, Vol. 22, No. 4](ICGA_Journal#22_4 "ICGA Journal")
7. [↑](#cite_ref-7) [Yngvi Björnsson](Yngvi_Bj%C3%B6rnsson "Yngvi Björnsson"), [Tony Marsland](Tony_Marsland "Tony Marsland") (**2001**). *Learning Search Control in Adversary Games*. [Advances in Computer Games 9](Advances_in_Computer_Games_9 "Advances in Computer Games 9"), [pdf](http://www.ru.is/faculty/yngvi/pdf/BjornssonM01b.pdf)
8. [↑](#cite_ref-8) [Levente Kocsis](Levente_Kocsis "Levente Kocsis"), [Jos Uiterwijk](Jos_Uiterwijk "Jos Uiterwijk"), [Jaap van den Herik](Jaap_van_den_Herik "Jaap van den Herik") (**2000**). *[Learning Time Allocation using Neural Networks](http://link.springer.com/chapter/10.1007/3-540-45579-5_11)*. [CG 2000](CG_2000 "CG 2000"), [postscript](http://zaphod.aml.sztaki.hu/papers/kocsis-CG00.ps)
9. [↑](#cite_ref-9) [AI Horizon: Machine Learning, Part II: Supervised and Unsupervised Learning](http://www.aihorizon.com/essays/generalai/supervised_unsupervised_machine_learning.htm)
10. [↑](#cite_ref-10) [online papers](http://satirist.org/learn-game/lists/papers.html) from [Machine Learning in Games](http://satirist.org/learn-game/) by [Jay Scott](Jay_Scott "Jay Scott")
11. [↑](#cite_ref-11) [Rosenblatt's Contributions](http://csis.pace.edu/~ctappert/srd2011/rosenblatt-contributions.htm)
12. [↑](#cite_ref-12) [Ratio Club from Wikipedia](https://en.wikipedia.org/wiki/Ratio_Club)
13. [↑](#cite_ref-13) [Royal Radar Establishment from Wikipedia](https://en.wikipedia.org/wiki/Royal_Radar_Establishment)
14. [↑](#cite_ref-14) see [Swap-off](Helmut_Richter#Swapoff "Helmut Richter") by [Helmut Richter](Helmut_Richter "Helmut Richter")
15. [↑](#cite_ref-15) [The abandonment of connectionism in 1969 - Wikipedia](https://en.wikipedia.org/wiki/AI_winter#The_abandonment_of_connectionism_in_1969)
16. [↑](#cite_ref-16) [Frank Rosenblatt](https://en.wikipedia.org/wiki/Frank_Rosenblatt) (**1962**). *[Principles of Neurodynamics: Perceptrons and the Theory of Brain Mechanisms](http://catalog.hathitrust.org/Record/000203591)*. Spartan Books
17. [↑](#cite_ref-17) [Long short term memory from Wikipedia](https://en.wikipedia.org/wiki/Long_short_term_memory)
18. [↑](#cite_ref-18) [Tsumego from Wikipedia](https://en.wikipedia.org/wiki/Tsumego)
19. [↑](#cite_ref-19) [Learnable Evolution Model from Wikipedia](https://en.wikipedia.org/wiki/Learnable_Evolution_Model)
20. [↑](#cite_ref-20) [Jean Hayes Michie](Jean_Hayes_Michie "Jean Hayes Michie") (**2001**). *[Machine Learning and Light Relief: A Review of Truth from Trash](https://www.aaai.org/ojs/index.php/aimagazine/article/view/1599/0)*. [AI Magazine](AAAI#AIMAG "AAAI"), Vol. 22 No. 4, [pdf](http://www.aaai.org/ojs/index.php/aimagazine/article/download/1599/1498)
21. [↑](#cite_ref-21) [University of Bristol - Department of Computer Science - Technical Reports](http://www.cs.bris.ac.uk/Publications/pub_master.jsp?type=117)
22. [↑](#cite_ref-22) [Generalized Hebbian Algorithm from Wikipedia](https://en.wikipedia.org/wiki/Generalized_Hebbian_Algorithm)
23. [↑](#cite_ref-23) [Dap Hartmann](Dap_Hartmann "Dap Hartmann") (**2010**). *Mimicking the Black Box - Genetically evolving evaluation functions and search algorithms*. Review on Omid David's Ph.D. Thesis, [ICGA Journal, Vol 33, No. 1](ICGA_Journal#33_1 "ICGA Journal")
24. [↑](#cite_ref-24) [Monte-Carlo Simulation Balancing - videolectures.net](http://videolectures.net/icml09_silver_mcsb/) by [David Silver](David_Silver "David Silver")
25. [↑](#cite_ref-25) [MATLAB from Wikipedia](https://en.wikipedia.org/wiki/MATLAB)
26. [↑](#cite_ref-26) [Weka (machine learning) from Wikipedia](https://en.wikipedia.org/wiki/Weka_(machine_learning))
27. [↑](#cite_ref-27) [Ms. Pac-Man from Wikipedia](https://en.wikipedia.org/wiki/Ms._Pac-Man)
28. [↑](#cite_ref-28) [Demystifying Deep Reinforcement Learning](http://www.nervanasys.com/demystifying-deep-reinforcement-learning/) by [Tambet Matiisen](http://www.nervanasys.com/author/tambet/), [Nervana](http://www.nervanasys.com/), December 21, 2015
29. [↑](#cite_ref-29) [Patent US20150100530 - Methods and apparatus for reinforcement learning - Google Patents](http://www.google.com/patents/US20150100530)
30. [↑](#cite_ref-30) [2048 (video game) from Wikipedia](https://en.wikipedia.org/wiki/2048_%28video_game%29)
31. [↑](#cite_ref-31) [Teaching Deep Convolutional Neural Networks to Play Go](http://computer-go.org/pipermail/computer-go/2014-December/007010.html) by [Hiroshi Yamashita](Hiroshi_Yamashita "Hiroshi Yamashita"), [The Computer-go Archives](http://computer-go.org/pipermail/computer-go/), December 14, 2014
32. [↑](#cite_ref-32) [Teaching Deep Convolutional Neural Networks to Play Go](http://www.talkchess.com/forum/viewtopic.php?t=54663) by [Michel Van den Bergh](Michel_Van_den_Bergh "Michel Van den Bergh"), [CCC](CCC "CCC"), December 16, 2014
33. [↑](#cite_ref-33) [Convolutional neural network from Wikipedia](https://en.wikipedia.org/wiki/Convolutional_neural_network)
34. [↑](#cite_ref-34) [Best Paper Awards | TAAI 2014](http://taai2014.ntust.edu.tw/best-paper-award/)
35. [↑](#cite_ref-35) [DeepChess: Another deep-learning based chess program](http://www.talkchess.com/forum/viewtopic.php?t=61748) by [Matthew Lai](Matthew_Lai "Matthew Lai"), [CCC](CCC "CCC"), October 17, 2016
36. [↑](#cite_ref-36) [ICANN 2016 | Recipients of the best paper awards](http://icann2016.org/index.php/conference-programme/recipients-of-the-best-paper-awards/)
37. [↑](#cite_ref-37) [Using GAN to play chess](http://www.talkchess.com/forum/viewtopic.php?t=63252) by Evgeniy Zheltonozhskiy, [CCC](CCC "CCC"), February 23, 2017
38. [↑](#cite_ref-38) [New DeepMind paper](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=72381) by GregNeto, [CCC](CCC "CCC"), November 21, 2019
39. [↑](#cite_ref-39) [MuZero: Mastering Go, chess, shogi and Atari without rules](https://deepmind.com/blog/article/muzero-mastering-go-chess-shogi-and-atari-without-rules?fbclid=IwAR3mSwrn1YXDKr9uuGm2GlFKh76wBilex7f8QvBiQecwiVmAvD6Bkyjx-rE)
40. [↑](#cite_ref-40) [Naive Bayes classifier from Wikipedia](https://en.wikipedia.org/wiki/Naive_Bayes_classifier)
41. [↑](#cite_ref-41) [Amir Ban](Amir_Ban "Amir Ban") (**2012**). *[Automatic Learning of Evaluation, with Applications to Computer Chess](http://www.ratio.huji.ac.il/node/2362)*. Discussion Paper 613, [The Hebrew University of Jerusalem](https://en.wikipedia.org/wiki/Hebrew_University_of_Jerusalem) - Center for the Study of Rationality, [Givat Ram](https://en.wikipedia.org/wiki/Givat_Ram)
42. [↑](#cite_ref-42) [Christopher Clark](Christopher_Clark "Christopher Clark"), [Amos Storkey](Amos_Storkey "Amos Storkey") (**2014**). *Teaching Deep Convolutional Neural Networks to Play Go*. [arXiv:1412.3409](http://arxiv.org/abs/1412.3409)
43. [↑](#cite_ref-43) [Chris J. Maddison](Chris_J._Maddison "Chris J. Maddison"), [Aja Huang](Shih-Chieh_Huang "Shih-Chieh Huang"), [Ilya Sutskever](Ilya_Sutskever "Ilya Sutskever"), [David Silver](David_Silver "David Silver") (**2014**). *Move Evaluation in Go Using Deep Convolutional Neural Networks*. [arXiv:1412.6564v1](http://arxiv.org/abs/1412.6564v1)
