...
1. <a id="cite-ref-1" href="#cite-note-1">↑</a> [Ernst A. Heinz](Ernst_A._Heinz "Ernst A. Heinz") (**1998**). *[Efficient Interior-Node Recognition](http://people.csail.mit.edu/heinz/dt/node33.html).* [ICCA Journal, Vol. 21, No. 3](ICGA_Journal#21_3 "ICGA Journal")
1. <a id="cite-ref-2" href="#cite-note-2">↑</a> [Fischerle 0.9.80 SE](http://www.stuckardt.de/rsdokumente/Fischerle_0_9_80_SE_64_or_32.rar) (March 24, 2017)
...
1. <a id="cite-ref-4" href="#cite-note-4">↑</a> "A person who does not play chess, is not a man", [direct speech](https://en.wikipedia.org/wiki/Direct_speech) in [Viennese German](https://en.wikipedia.org/wiki/Viennese_German) of Fischerle to [Kien](https://en.wikipedia.org/wiki/Auto-da-F%C3%A9#Plot_and_themes), in
