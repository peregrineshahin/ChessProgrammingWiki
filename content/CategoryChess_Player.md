---
title: CategoryChess Player
---
## Category:Chess Player



This category lists Chess programming related people who are also [Chess player](https://en.wikipedia.org/wiki/List_of_chess_players).
...
- [Chess Legend](Category:Chess_Legend "Category:Chess Legend")

### D

- [Marcel Duchamp](Category:Marcel_Duchamp "Category:Marcel Duchamp")

### J

- [Carina Jørgensen](Category:Carina_J%C3%B8rgensen "Category:Carina Jørgensen")

### K

- [Hans Kmoch](Category:Hans_Kmoch "Category:Hans Kmoch")

## Pages in category "Chess Player"

The following 200 pages are in this category, out of 243 total.

(previous page) ([next page](index.php?title=Category:Chess_Player&pagefrom=Seidel%0AReiner+Seidel#mw-pages "Category:Chess Player"))### A
...
- [Natalia Parés](Natalia_Par%C3%A9s "Natalia Parés")
...
- [Pablo San Segundo](Pablo_San_Segundo "Pablo San Segundo")
  (previous page) ([next page](index.php?title=Category:Chess_Player&pagefrom=Seidel%0AReiner+Seidel#mw-pages "Category:Chess Player"))
