...
In others contexts, the word _stalemate_ is also used for a [metaphor](https://en.wikipedia.org/wiki/Metaphor) when a conflict resolution seems difficult or impossible, i.e. a [lose-lose situation](https://en.wikipedia.org/wiki/No-win_situation).
...
- [Karsten Müller](Karsten_M%C3%BCller "Karsten Müller"), [Guy Haworth](Guy_Haworth "Guy Haworth") (**2019**). _Stalemate and ‘DTS’ depth to stalemate endgame tables_. [ICGA Journal, Vol. 41, No. 4](ICGA_Journal#41_4 "ICGA Journal") » [Endgame Tablebases](Endgame_Tablebases "Endgame Tablebases")
