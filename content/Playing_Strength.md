...
---
**[Home](Home "Home") \* [Chess](Chess "Chess") \* Playing Strength**



 [](http://wiki.huen-un-perduen.de/index.php?title=Datei:Flottmann04.jpg) Dragon and Snake on ambos <a id="cite-note-1" href="#cite-ref-1">[1]</a> 
...
The strength of a chess program depends on many things, the quality and efficiency of the [algorithms](Algorithms "Algorithms") involved to determine the best move of a position, the balance of the so called [search](Search "Search") versus [knowledge tradeoff](Knowledge "Knowledge") to [evaluate](Evaluation "Evaluation") or compare [leaf nodes](Leaf_Node "Leaf Node") of a [search tree](Search_Tree "Search Tree"), how to shape that tree and to propagate a [score](Score "Score") up to the [root](Root "Root"), and [time management](Time_Management "Time Management"), that is how to allocate time for searching a move under time control requirements. Time used is roughly proportional to the number of visited [nodes](Node "Node") of the common [depth-first search](Depth-First "Depth-First") inside an [iterative deepening frame](Iterative_Deepening "Iterative Deepening"), which [grows exponentially](https://en.wikipedia.org/wiki/Exponential_growth) by its [effective branching factor](Branching_Factor#EffectiveBranchingFactor "Branching Factor") raised to the power of [search depth](Depth "Depth"). Playing strength might be improved over the (playing) time due to [learning algorithms](Learning "Learning").
...
* [Jean-Marc Alliot - Who is the Master?](Jean-Marc_Alliot#WhoistheMaster "Jean-Marc Alliot")
...
* [Peter W. Frey](Peter_W._Frey "Peter W. Frey") (ed.) (**1977**). *[Chess Skill in Man and Machine](Chess_Skill_in_Man_and_Machine "Chess Skill in Man and Machine")*. Springer, New York, N.Y. 2nd ed. 1983
...
* [Arpad Elo](https://en.wikipedia.org/wiki/Arpad_Elo) (**1978**). *The Rating of Chessplayers, Past and Present*. Arco Publications <a id="cite-note-6" href="#cite-ref-6">[6]</a>
* [Don Beal](Don_Beal "Don Beal") (**1978**). *Handicapping Computer Chess Programs*. [ICCA Newsletter, Vol. 1, No. 2](ICGA_Journal#1_2 "ICGA Journal")
...
* [Matej Guid](Matej_Guid "Matej Guid"), [Ivan Bratko](Ivan_Bratko "Ivan Bratko") (**2006**). *Computer Analysis of World Chess Champions*. [ICGA Journal, Vol. 29, No. 2](ICGA_Journal#29_2 "ICGA Journal"), [pdf](http://www.ailab.si/matej/doc/Computer_Analysis_of_World_Chess_Champions.pdf) <a id="cite-note-7" href="#cite-ref-7">[7]</a><a id="cite-note-8" href="#cite-ref-8">[8]</a>
* [Matej Guid](Matej_Guid "Matej Guid"), [Ivan Bratko](Ivan_Bratko "Ivan Bratko") (**2006**). *[Computer Analysis of Chess Champions](http://link.springer.com/chapter/10.1007/978-3-540-75538-8_1)*. [CG 2006](CG_2006 "CG 2006")
...
* [Matej Guid](Matej_Guid "Matej Guid"), [Aritz Pérez](Aritz_P%C3%A9rez "Aritz Pérez"), [Ivan Bratko](Ivan_Bratko "Ivan Bratko") (**2007**). *How trustworthy is Crafty's analysis of world chess champions*? [CGW 2007](CGW_2007 "CGW 2007") » [Crafty](Crafty "Crafty")
...
* [Rémi Coulom](R%C3%A9mi_Coulom "Rémi Coulom") (**2008**). *[Whole-History Rating: A Bayesian Rating System for Players of Time-Varying Strength](http://link.springer.com/chapter/10.1007/978-3-540-87608-3_11)*. [CG 2008](CG_2008 "CG 2008")
...
* [Matej Guid](Matej_Guid "Matej Guid"), [Ivan Bratko](Ivan_Bratko "Ivan Bratko") (**2011**). *Using Heuristic-Search Based Engines for Estimating Human Skill at Chess*. [ICGA Journal, Vol. 34, No. 2](ICGA_Journal#34_2 "ICGA Journal")
...
* [Daniel Shawul](Daniel_Shawul "Daniel Shawul"), [Rémi Coulom](R%C3%A9mi_Coulom "Rémi Coulom") (**2013**). *Paired Comparisons with Ties: Modeling Game Outcomes in Chess*. <a id="cite-note-12" href="#cite-ref-12">[12]</a> <a id="cite-note-13" href="#cite-ref-13">[13]</a>
* [Diogo R. Ferreira](Diogo_R._Ferreira "Diogo R. Ferreira") (**2013**). *The Impact of the Search Depth on Chess Playing Strength*. [ICGA Journal, Vol. 36, No. 2](ICGA_Journal#36_2 "ICGA Journal") » [Depth](Depth "Depth"), [Diminishing Returns](Depth#DiminishingReturns "Depth"), [Match Statistics](Match_Statistics "Match Statistics"), [Houdini](Houdini "Houdini") <a id="cite-note-14" href="#cite-ref-14">[14]</a>
...
* [Ashton Anderson](Ashton_Anderson "Ashton Anderson"), [Jon Kleinberg](Jon_Kleinberg "Jon Kleinberg"), [Sendhil Mullainathan](index.php?title=Sendhil_Mullainathan&action=edit&redlink=1 "Sendhil Mullainathan (page does not exist)") (**2016**). *Assessing Human Error Against a Benchmark of Perfection*. [ACM SIGKDD 2016](ACM#SIGKDD "ACM"), [arXiv:1606.04956](https://arxiv.org/abs/1606.04956)
...
* [Ashton Anderson](Ashton_Anderson "Ashton Anderson"), [Etan A. Green](https://scholar.google.com/citations?user=l480S2EAAAAJ&hl=en) (**2018**). *[Personal bests as reference points](https://www.pnas.org/content/115/8/1772)*. [PNAS](https://en.wikipedia.org/wiki/Proceedings_of_the_National_Academy_of_Sciences_of_the_United_States_of_America), Vol. 115, No. 8 <a id="cite-note-17" href="#cite-ref-17">[17]</a>
...
* [Leszek Szczecinski](index.php?title=Leszek_Szczecinski&action=edit&redlink=1 "Leszek Szczecinski (page does not exist)"), [Aymen Djebbi](index.php?title=Aymen_Djebbi&action=edit&redlink=1 "Aymen Djebbi (page does not exist)") (**2019**). *Understanding and Pushing the Limits of the Elo Rating Algorithm*. [arXiv:1910.06081](https://arxiv.org/abs/1910.06081) <a id="cite-note-18" href="#cite-ref-18">[18]</a>
...
* [chess strength](http://quux.org:70/Archives/usenet-a-news/NET.chess/82.01.07_alice.349_net.chess.txt) by [Ken Thompson](Ken_Thompson "Ken Thompson"), [net.chess](http://quux.org:70/Archives/usenet-a-news/NET.chess), January 7, 1982 » [Depth | Diminishing Returns](Depth#DiminishingReturns "Depth")


### 1990 ...


* [Weakest Chess Program needed](https://groups.google.com/d/msg/rec.games.chess/Qe_5lhAWTsc/Uj9UNvUrb0AJ) by Jones Maxime Murphy, [rgc](Computer_Chess_Forums "Computer Chess Forums"), November 12, 1991
* [Estimating Playing Strength of Computers (was: Re: Rating of Radio Shack 1650)](https://groups.google.com/d/msg/rec.games.chess/qH7LeruGk7E/J1fuNeXx2eMJ) by Peter Marko, [rgc](Computer_Chess_Forums "Computer Chess Forums"), September 15, 1992 » [SciSys Explorer](SciSys_Explorer "SciSys Explorer")
* [Rating boundaries](https://groups.google.com/d/msg/rec.games.chess/clI1kBtbGJM/Izx6gGvPIzEJ) by Kevin Stokker, [rgc](Computer_Chess_Forums "Computer Chess Forums"), January 14, 1993
* [Cognitive Psychology and Chess Skill](https://groups.google.com/d/msg/rec.games.chess/0Ml8HZYzFVQ/0As11AGu8KMJ) by John Rummel, [rgc](Computer_Chess_Forums "Computer Chess Forums"), June 07, 1994 » [Cognition](Cognition "Cognition")


### 1995 ...


* [Computer Strength](https://groups.google.com/d/msg/rec.games.chess/2EHwLFQzeWE/cfNfLEYkLacJ) by Christopher Dorr, [rgcc](Computer_Chess_Forums "Computer Chess Forums"), May 22, 1995
...
* [Rating of perfect chess](https://groups.google.com/d/msg/rec.games.chess/ENWDInLp9yQ/JF9dKASgAOYJ) by an18...@anon.penet.fi, [rgc](Computer_Chess_Forums "Computer Chess Forums"), July 17, 1995
...
* [ELO performance?](https://www.stmintz.com/ccc/index.php?id=52542) by [Stefan Meyer-Kahlen](Stefan_Meyer-Kahlen "Stefan Meyer-Kahlen"), [CCC](CCC "CCC"), May 22, 1999 » [Match Statistics](Match_Statistics "Match Statistics"), [Pawn Advantage, Win Percentage, and Elo](Pawn_Advantage,_Win_Percentage,_and_Elo "Pawn Advantage, Win Percentage, and Elo")
* [from "Scacco": No steps forward in Computer Chess in the Last years !?](https://www.stmintz.com/ccc/index.php?id=69215) by [Gianluigi Masciulli](Gianluigi_Masciulli "Gianluigi Masciulli"), [CCC](CCC "CCC"), September 18, 1999


### 2000 ...


* [ELO of the chess programs in the 2010](https://www.stmintz.com/ccc/index.php?id=183787) by [Federico Corigliano](Federico_Andr%C3%A9s_Corigliano "Federico Andrés Corigliano"), [CCC](CCC "CCC"), August 15, 2001
* [Strength of the engine in chess programs](https://www.stmintz.com/ccc/index.php?id=230488) by [Rolf Tueschen](Rolf_T%C3%BCschen "Rolf Tüschen"), [CCC](CCC "CCC"), May 20, 2002
* [Value of playing different versions of a program against each other](https://www.stmintz.com/ccc/index.php?id=275347) by [Tom King](Tom_King "Tom King"), [CCC](CCC "CCC"), January 06, 2003  » [Engine Testing](Engine_Testing "Engine Testing")
* [Rules of thumb for strength estimation?](https://www.stmintz.com/ccc/index.php?id=294537) by [Albert Bertilsson](Albert_Bertilsson "Albert Bertilsson"), [CCC](CCC "CCC"), April 25, 2003
...
* [A thought about ratings](https://groups.google.com/d/msg/computer-go-archive/iZmzbavlbsI/oLGjUFelN3UJ) by Dave Dyer, [Computer Go Archive](https://groups.google.com/forum/#!forum/computer-go-archive), December 10, 2007 » [Go](Go "Go")


 [Re: A thought about ratings](https://groups.google.com/d/msg/computer-go-archive/iZmzbavlbsI/1EJf4q2L4HIJ) by [Don Dailey](Don_Dailey "Don Dailey"), [Computer Go Archive](https://groups.google.com/forum/#!forum/computer-go-archive), December 10, 2007
 [Re: A thought about ratings](https://groups.google.com/d/msg/computer-go-archive/iZmzbavlbsI/Z2AsWFaUu-EJ) by [Edward de Grijs](Edward_de_Grijs "Edward de Grijs"), [Computer Go Archive](https://groups.google.com/forum/#!forum/computer-go-archive), December 10, 2007
 [Re: A thought about ratings](https://groups.google.com/d/msg/computer-go-archive/iZmzbavlbsI/K-5UMaK_CsYJ) by [Don Dailey](Don_Dailey "Don Dailey"), [Computer Go Archive](https://groups.google.com/forum/#!forum/computer-go-archive), December 10, 2007
**2008**



* [Glaurung Mac OS X: New GUI, now with adjustable strength.](http://www.talkchess.com/forum/viewtopic.php?t=21208) by [Tord Romstad](Tord_Romstad "Tord Romstad"), [CCC](CCC "CCC"), May 18, 2008 » [Glaurung](Glaurung "Glaurung")
* [Artificial stupidity - making a program play badly](http://www.talkchess.com/forum/viewtopic.php?t=21264) by [Tord Romstad](Tord_Romstad "Tord Romstad"), [CCC](CCC "CCC"), May 20, 2008
* [New testing thread](http://www.talkchess.com/forum/viewtopic.php?t=22832) by [Robert Hyatt](Robert_Hyatt "Robert Hyatt"), [CCC](CCC "CCC"), August 07, 2008 » [Engine Testing](Engine_Testing "Engine Testing")
...
* [Hardware vs Software](http://www.talkchess.com/forum/viewtopic.php?t=25215) by [Charles Roberson](Charles_Roberson "Charles Roberson"), [CCC](CCC "CCC"), December 02, 2008
...
* [Speed/ELO relationship, and question to engine programmers](http://www.talkchess.com/forum/viewtopic.php?t=26817) by [Russell Reagan](Russell_Reagan "Russell Reagan"), [CCC](CCC "CCC"), March 02, 2009
...
* [How to reduce playing strenght to play against humans](http://www.talkchess.com/forum/viewtopic.php?t=33089) by [Fermin Serrano](Fermin_Serrano "Fermin Serrano"), [CCC](CCC "CCC"), March 05, 2010
* [Current skill command (Crafty) results](http://www.talkchess.com/forum/viewtopic.php?t=35531) by [Robert Hyatt](Robert_Hyatt "Robert Hyatt"), [CCC](CCC "CCC"), July 21, 2010 » [Crafty](Crafty "Crafty")
* [harware vs software advances](http://www.talkchess.com/forum/viewtopic.php?t=36006) by [Don Dailey](Don_Dailey "Don Dailey"), [CCC](CCC "CCC"), September 08, 2010
...
* [StockFish LS with LimitStrength feature](http://www.talkchess.com/forum/viewtopic.php?t=41732) by [Alexander Schmidt](index.php?title=Alexander_Schmidt&action=edit&redlink=1 "Alexander Schmidt (page does not exist)"), [CCC](CCC "CCC"), January 01, 2012 » [Stockfish](Stockfish "Stockfish")
* [Depth vs playing strength](http://www.talkchess.com/forum/viewtopic.php?t=41902) by David Whitten, [CCC](CCC "CCC"), January 09, 2012
* [Reducing Strength](http://www.talkchess.com/forum/viewtopic.php?t=42880) by Ted Wong, [CCC](CCC "CCC"), March 15, 2012
* [Human Elo ratings: averages and standard deviations](http://www.talkchess.com/forum/viewtopic.php?t=44219) by [Jesús Muñoz](index.php?title=Jes%C3%BAs_Mu%C3%B1oz&action=edit&redlink=1 "Jesús Muñoz (page does not exist)"), [CCC](CCC "CCC"), March 18, 2012
...
* [Score Inaccuracy: An Engine Weakening Algorithm](http://www.talkchess.com/forum/viewtopic.php?t=45795) by [Erik Madsen](Erik_Madsen "Erik Madsen"), [CCC](CCC "CCC"), October 31, 2012 » [MadChess](MadChess "MadChess")
...
* [Scaling at 2x nodes (or doubling time control)](http://www.talkchess.com/forum/viewtopic.php?t=48733) by [Kai Laskos](Kai_Laskos "Kai Laskos"), [CCC](CCC "CCC"), July 23, 2013 » [Doubling TC](Match_Statistics#DoublingTC "Match Statistics"), [Diminishing Returns](Depth#DiminishingReturns "Depth"), Playing Strength, [Houdini](Houdini "Houdini")
...
* [ELO rating and thinking time](http://www.talkchess.com/forum/viewtopic.php?t=50173) by [Henk van den Belt](index.php?title=Henk_van_den_Belt&action=edit&redlink=1 "Henk van den Belt (page does not exist)"), [CCC](CCC "CCC"), November 22, 2013
...
* [MadChess UCI\_LimitStrength Algorithm](http://www.talkchess.com/forum/viewtopic.php?t=51973) by [Erik Madsen](Erik_Madsen "Erik Madsen"), [CCC](CCC "CCC"), April 12, 2014 » [MadChess](MadChess "MadChess"), [UCI](UCI "UCI")
...
* [How many Elo points change for a doubling of uP time?](http://www.talkchess.com/forum/viewtopic.php?t=53287) by Jay Rodrequez, [CCC](CCC "CCC"), August 14, 2014
...
* [Questions regarding rating systems of humans and engines](http://www.talkchess.com/forum/viewtopic.php?t=54571) by [Erik Varend](index.php?title=Erik_Varend&action=edit&redlink=1 "Erik Varend (page does not exist)"), [CCC](CCC "CCC"), December 06, 2014
...
* [The future of chess and elo ratings](http://www.talkchess.com/forum/viewtopic.php?t=57696) by [Larry Kaufman](Larry_Kaufman "Larry Kaufman"), [CCC](CCC "CCC"), September 20, 2015
...
* [Computer Chess Strength](http://www.talkchess.com/forum/viewtopic.php?p=661996) by [John Fishburn](John_Philip_Fishburn "John Philip Fishburn"), [CCC](CCC "CCC"), February 28, 2016
* [How much benefit from opening book?](http://www.talkchess.com/forum/viewtopic.php?p=662580) by [John Fishburn](John_Philip_Fishburn "John Philip Fishburn"), [CCC](CCC "CCC"), March 06, 2016 » [Opening Book](Opening_Book "Opening Book")
* [Computer chess progress over say the last 20 years?](http://www.talkchess.com/forum/viewtopic.php?t=59470) by [Martin Fierz](Martin_Fierz "Martin Fierz"), [CCC](CCC "CCC"), March 10, 2016
* [Computer chess progress over the last 20 years!](http://www.talkchess.com/forum/viewtopic.php?t=59497) by [Martin Fierz](Martin_Fierz "Martin Fierz"), [CCC](CCC "CCC"), March 13, 2016
* [Computer Chess Progress: Stockfish 7 vs Ruffian 1.0.5](http://www.talkchess.com/forum/viewtopic.php?t=59543) by [Martin Fierz](Martin_Fierz "Martin Fierz"), [CCC](CCC "CCC"), March 17, 2016 » [Stockfish](Stockfish "Stockfish"), [Ruffian](Ruffian "Ruffian")
* [skill levels](http://www.talkchess.com/forum/viewtopic.php?t=59982) by [Alexandru Mosoi](Alexandru_Mosoi "Alexandru Mosoi"), [CCC](CCC "CCC"), April 28, 2016
...
* [ELO inflation ha ha ha](http://www.talkchess.com/forum/viewtopic.php?t=61444) by [Henk van den Belt](index.php?title=Henk_van_den_Belt&action=edit&redlink=1 "Henk van den Belt (page does not exist)"), [CCC](CCC "CCC"), September 16, 2016 » [Delphil](Delphil "Delphil"), [Stockfish](Stockfish "Stockfish"), [Match Statistics](Match_Statistics "Match Statistics"), [TCEC Season 9](TCEC_Season_9 "TCEC Season 9") <a id="cite-note-19" href="#cite-ref-19">[19]</a>
...
* [Doubling of time control](http://www.talkchess.com/forum/viewtopic.php?t=61784) by [Andreas Strangmüller](Andreas_Strangm%C3%BCller "Andreas Strangmüller"), [CCC](CCC "CCC"), October 21, 2016 » [Doubling TC](Match_Statistics#DoublingTC "Match Statistics"), [Diminishing Returns](Depth#DiminishingReturns "Depth"), Playing Strength, [Komodo](Komodo "Komodo")
* [UCI protocol and engine strength](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=61935) by [Fermin Serrano](Fermin_Serrano "Fermin Serrano"), [CCC](CCC "CCC"), November 02, 2016
* [Stockfish 8 - Double time control vs. 2 threads](http://www.talkchess.com/forum/viewtopic.php?t=62146) by [Andreas Strangmüller](Andreas_Strangm%C3%BCller "Andreas Strangmüller"), [CCC](CCC "CCC"), November 15, 2016 » [Doubling TC](Match_Statistics#DoublingTC "Match Statistics"), [Diminishing Returns](Depth#DiminishingReturns "Depth"), Playing Strength, [Stockfish](Stockfish "Stockfish")
* [L3 cache, RAM and other performance factors](http://rybkaforum.net/cgi-bin/rybkaforum/topic_show.pl?tid=31867) by Nimzy, [Rybka Forum](Computer_Chess_Forums "Computer Chess Forums"), December 04, 2016 » [Memory](Memory "Memory")
...
* [Diminishing returns and hyperthreading](http://www.talkchess.com/forum/viewtopic.php?t=62622) by [Kai Laskos](Kai_Laskos "Kai Laskos"), [CCC](CCC "CCC"), December 27, 2016 » [Diminishing Returns](Depth#DiminishingReturns "Depth"), [Match Statistics](Match_Statistics "Match Statistics"), [Thread](Thread "Thread")
...
* [Progress in 30 years by four intervals of 7-8 years](http://www.talkchess.com/forum/viewtopic.php?t=62868) by [Kai Laskos](Kai_Laskos "Kai Laskos"), [CCC](CCC "CCC"), January 19, 2017 » [Match Statistics](Match_Statistics "Match Statistics")
* [Crafty Play By Elo ( Crafty v25.3)](http://www.talkchess.com/forum/viewtopic.php?t=62907) by [Michael B](Michael_Byrne "Michael Byrne"), [CCC](CCC "CCC"), January 23, 2017 » [Crafty](Crafty "Crafty")
* [6-men Syzygy from HDD and USB 3.0](http://www.talkchess.com/forum/viewtopic.php?t=63652) by [Kai Laskos](Kai_Laskos "Kai Laskos"), [CCC](CCC "CCC"), April 04, 2017 » [Komodo](Komodo "Komodo"), [Syzygy Bases](Syzygy_Bases "Syzygy Bases"), [USB 3.0](Memory#USB3 "Memory")
...
* [RAM speed and engine strength](http://www.talkchess.com/forum/viewtopic.php?t=63886) by John Hartmann, [CCC](CCC "CCC"), May 03, 2017 » [RAM](Memory#RAM "Memory")
...
* [Another attempt at comparing Evals ELO-wise](http://www.talkchess.com/forum/viewtopic.php?t=64041) by [Kai Laskos](Kai_Laskos "Kai Laskos"), [CCC](CCC "CCC"), May 22, 2017 » [Evaluation](Evaluation "Evaluation")
* [Testing endgame strength](http://www.talkchess.com/forum/viewtopic.php?t=64356) by [Álvaro Begué](%C3%81lvaro_Begu%C3%A9 "Álvaro Begué"), [CCC](CCC "CCC"), June 21, 2017 » [Endgame](Endgame "Endgame"), [Engine Testing](Engine_Testing "Engine Testing"), [RuyDos](RuyDos "RuyDos")
* [Measuring elo rating engine outside tournament](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=64512) by [Yves De Billoëz](Yves_De_Billo%C3%ABz "Yves De Billoëz"), [CCC](CCC "CCC"), July 04, 2017
* [Invariance with time control of rating schemes](http://www.talkchess.com/forum/viewtopic.php?t=64683) by [Kai Laskos](Kai_Laskos "Kai Laskos"), [CCC](CCC "CCC"), July 22, 2017 <a id="cite-note-20" href="#cite-ref-20">[20]</a>
...
* [ELO measurements](http://www.talkchess.com/forum/viewtopic.php?t=64824&start=3) by [Peter Österlund](Peter_%C3%96sterlund "Peter Österlund"), [CCC](CCC "CCC"), August 06, 2017 » [Lazy SMP](Lazy_SMP "Lazy SMP"), [Parallel Search](Parallel_Search "Parallel Search")
* [an interesting study from Erik Varend](http://www.hiarcs.net/forums/viewtopic.php?t=8526) by scandien, [Hiarcs Forum](Computer_Chess_Forums "Computer Chess Forums"), August 13, 2017 <a id="cite-note-21" href="#cite-ref-21">[21]</a>
* [Wall and Regression](http://www.talkchess.com/forum/viewtopic.php?t=65048) by [Srdja Matovic](Srdja_Matovic "Srdja Matovic"), [CCC](CCC "CCC"), August 31, 2017 <a id="cite-note-22" href="#cite-ref-22">[22]</a> <a id="cite-note-23" href="#cite-ref-23">[23]</a>
...
* [Is modern chess software lossless or lossy?](http://www.talkchess.com/forum/viewtopic.php?t=66298) by Meni Rosenfeld, [CCC](CCC "CCC"), January 10, 2018 » [Selectivity](Selectivity "Selectivity")
...
* [Elo measurement of contempt in SF in self-play](http://www.talkchess.com/forum/viewtopic.php?t=66793) by [Michel Van den Bergh](Michel_Van_den_Bergh "Michel Van den Bergh"), [CCC](CCC "CCC"), March 10, 2018 » [Contempt](Contempt_Factor "Contempt Factor"), [Stockfish](Stockfish "Stockfish")
...
* [Depth reduced but ELO increased](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=70217) by [Tom King](Tom_King "Tom King"), [CCC](CCC "CCC"), March 16, 2019 » [Countermove Heuristic](Countermove_Heuristic "Countermove Heuristic")
* [Elo World, a framework for benchmarking weak chess engines](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=70388) by [Rémi Coulom](R%C3%A9mi_Coulom "Rémi Coulom"), [CCC](CCC "CCC"), April 02, 2019
* [What engine breaks even with GMs in blitz?](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=70440) by [Larry Kaufman](Larry_Kaufman "Larry Kaufman"), [CCC](CCC "CCC"), April 07, 2019
...
* [Dedicated Chess Machine Elo vs Human Elo, a least squares analysis](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=71639) by JayRod, [CCC](CCC "CCC"), August 23, 2019 » [Dedicated Chess Computers](Dedicated_Chess_Computers "Dedicated Chess Computers")
* [Limiting nodes to reduce engine strength](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=72183) by [Patrice Duhamel](Patrice_Duhamel "Patrice Duhamel"), [CCC](CCC "CCC"), October 26, 2019
...
* [How many Elo points is a book?](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=75205) by [Chris Whittington](Chris_Whittington "Chris Whittington"), [CCC](CCC "CCC"), September 25, 2020 » [Opening Book](Opening_Book "Opening Book")
...
* [Blunder option](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=76181) by [Colin Jenkins](Colin_Jenkins "Colin Jenkins"), [CCC](CCC "CCC"), December 29, 2020
* [Dispelling the Myth of NNUE with LazySMP: An Analysis](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=76190) by [Andrew Grant](Andrew_Grant "Andrew Grant"), [CCC](CCC "CCC"), December 30, 2020 » [NNUE](NNUE "NNUE"), [Lazy SMP](Lazy_SMP "Lazy SMP"), [Thread](Thread "Thread")
* [Evaluation of moves from World Championship Games](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=76198) by [Ferdinand Mosca](Ferdinand_Mosca "Ferdinand Mosca"), [CCC](CCC "CCC"), December 31, 2020
...
* [What K factor should be used if two players are in different K factor brackets?](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=76261) by [Tamás Kuzmics](Tam%C3%A1s_Kuzmics "Tamás Kuzmics"), [CCC](CCC "CCC"), January 09, 2021 <a id="cite-note-24" href="#cite-ref-24">[24]</a> <a id="cite-note-25" href="#cite-ref-25">[25]</a>
...
* [Ares playing strength at various fixed depth levels](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=77501) by [Charles Roberson](Charles_Roberson "Charles Roberson"), [CCC](CCC "CCC"), June 16, 2021 » [Ares](Ares_US "Ares US")
...
* [How much ELO should I expect to gain from killer moves?](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=77734) by Christian Dean, [CCC](CCC "CCC"), July 16, 2021 » [Killer Heuristic](Killer_Heuristic "Killer Heuristic")
* [Elo expected from LMR](https://www.talkchess.com/forum3/viewtopic.php?f=7&t=78397) by Christian Dean, [CCC](CCC "CCC"), October 11, 2021 » [Late Move Reductions](Late_Move_Reductions "Late Move Reductions")
...
* [Comparison of top chess players throughout history from Wikipedia](https://en.wikipedia.org/wiki/Comparison_of_top_chess_players_throughout_history)
* [Adolf Anderssen - Playing strength and style from Wikipedia](https://en.wikipedia.org/wiki/Adolf_Anderssen#Playing_strength_and_style)
* [Magnus Carlsen - Rating from Wikipedia](https://en.wikipedia.org/wiki/Magnus_Carlsen#Rating)
* [Garry Kasparov Chess ratings achievements from Wikipedia](https://en.wikipedia.org/wiki/Garry_Kasparov#Chess_ratings_achievements)
* [Fred Reinfeld | Playing strength from Wikipedia](https://en.wikipedia.org/wiki/Fred_Reinfeld#Playing_strength)
* [József Szén | Playing strength from Wikipedia](https://en.wikipedia.org/wiki/J%C3%B3zsef_Sz%C3%A9n#Playing_strength)


### Chess Engines


* [Chess engine - Increasing strength from Wikipedia](https://en.wikipedia.org/wiki/Chess_engine#Increasing_strength)
* [ChessGenius - Playing strength from Wikipedia](https://en.wikipedia.org/wiki/ChessGenius#Playing_strength)
* [Chess Tiger - Playing strength from Wikipedia](https://en.wikipedia.org/wiki/Chess_Tiger#Playing_strength)
* [Komodo (chess) - Playing strength and style from Wikipedia](https://en.wikipedia.org/wiki/Komodo_%28chess%29#Playing_strength_and_style)
* [MChess Pro - Playing strength from Wikipedia](https://en.wikipedia.org/wiki/MChess_Pro#Playing_strength)
* [The Strongest Computer Chess Engines Over Time from 1985 to 2019](https://youtu.be/wljgxS7tZVE), by [Chess.com](index.php?title=Chess.com&action=edit&redlink=1 "Chess.com (page does not exist)"), May 20, 2020 <a id="cite-note-26" href="#cite-ref-26">[26]</a>, [YouTube](https://en.wikipedia.org/wiki/YouTube) Video
...
* [Computers choose: who was the strongest player?](http://en.chessbase.com/post/computers-choose-who-was-the-strongest-player-), [ChessBase News](ChessBase "ChessBase"), October 30, 2006
* [Computer analysis of world champions](http://en.chessbase.com/post/computer-analysis-of-world-champions) by [Søren Riis](S%C3%B8ren_Riis "Søren Riis"), [ChessBase News](ChessBase "ChessBase"), November 02, 2006 <a id="cite-note-27" href="#cite-ref-27">[27]</a>
* [Chessanalysis homepage](http://www.chessanalysis.ee/chessanalysiseng.htm) by [Erik Varend](index.php?title=Erik_Varend&action=edit&redlink=1 "Erik Varend (page does not exist)") <a id="cite-note-28" href="#cite-ref-28">[28]</a>
...
* [Strength from Wikipedia](https://en.wikipedia.org/wiki/Strength)
* [Strength of schedule from Wikipedia](https://en.wikipedia.org/wiki/Strength_of_schedule)
* [go from strength to strength - Wiktionary](https://en.wiktionary.org/wiki/go_from_strength_to_strength)
* [Spielstärke | Wikipedia.de](https://de.wikipedia.org/wiki/Spielst%C3%A4rke) (German)
* [Sports rating system from Wikipedia](https://en.wikipedia.org/wiki/Sports_rating_system)
* [Performance (disambiguation) from Wikipedia](https://en.wikipedia.org/wiki/Performance_(disambiguation))
* [performance - Wiktionary](https://en.wiktionary.org/wiki/performance)
* [Playing Strength and Gender at Sensei's Library](http://senseis.xmp.net/?PlayingStrengthAndGender)
...
* [Chicago](Category:Chicago "Category:Chicago") - [Feelin' Stronger Every Day](https://en.wikipedia.org/wiki/Feelin%27_Stronger_Every_Day) (1973), [YouTube](https://en.wikipedia.org/wiki/YouTube) Video
...
1. <a id="cite-ref-1" href="#cite-note-1">↑</a> Photo by [Gerd Isenberg](Gerd_Isenberg "Gerd Isenberg"), September 18, 2016, detail of the [Flottmann gate](https://commons.wikimedia.org/wiki/Category:Flottmann-Tor), [Art Nouveau](https://en.wikipedia.org/wiki/Art_Nouveau) theme of *Dragon and Sun* designed by Carl Weinhold, art director of blacksmith and foundry *Füssmann und Fleeth*, [Essen](https://en.wikipedia.org/wiki/Essen), exposed at the [industrial and trade exhibition 1902](https://de.wikipedia.org/wiki/Industrie-_und_Gewerbeausstellung_D%C3%BCsseldorf) in [Düsseldorf](https://en.wikipedia.org/wiki/D%C3%BCsseldorf), and baught by [Heinrich Flottmann](https://de.wikipedia.org/wiki/Otto_Heinrich_Flottmann) as gate for his [jackhammer](https://en.wikipedia.org/wiki/Jackhammer) [factory](https://de.wikipedia.org/wiki/Flottmann-Werke), today adjacent to the exhibition and event space [Flottmann-Hallen](Category:Flottmann "Category:Flottmann") in [Herne](https://en.wikipedia.org/wiki/Herne,_North_Rhine-Westphalia), [North Rhine-Westphalia](https://en.wikipedia.org/wiki/North_Rhine-Westphalia), [Germany](https://en.wikipedia.org/wiki/Germany), and part of [The Industrial Heritage Trail](Category:Industrial_Heritage_Trail "Category:Industrial Heritage Trail") of the [Ruhr area](https://en.wikipedia.org/wiki/Ruhr), "The dragon is a symbol of physical strength and intelligence with respect to the snake that symbolizes the tough, glowing wrought iron" from [Flottmann-Tor – Hün un Perdün](http://wiki.huen-un-perduen.de/index.php?title=Flottmann-Tor), see also [Image](http://wiki.huen-un-perduen.de/index.php?title=Datei:Flottmann04.jpg) by Gerd Biedermann
...
3. <a id="cite-ref-3" href="#cite-note-3">↑</a> [Elo rating system - Mathematical details - Wikipedia](https://en.wikipedia.org/wiki/Elo_rating_system#Mathematical_details)
4. <a id="cite-ref-4" href="#cite-note-4">↑</a> [Stockfish Testing Framework](http://tests.stockfishchess.org/tests)
5. <a id="cite-ref-5" href="#cite-note-5">↑</a> [Comparison of top chess players throughout history from Wikipedia](https://en.wikipedia.org/wiki/Comparison_of_top_chess_players_throughout_history)
6. <a id="cite-ref-6" href="#cite-note-6">↑</a> [Elo's Book: The Rating of Chess Players](http://www.anusha.com/elosbook.htm) by [Sam Sloan](Sam_Sloan "Sam Sloan")
7. <a id="cite-ref-7" href="#cite-note-7">↑</a> [Computers choose: who was the strongest player?](http://en.chessbase.com/post/computers-choose-who-was-the-strongest-player-), [ChessBase News](ChessBase "ChessBase"), October 30, 2006
8. <a id="cite-ref-8" href="#cite-note-8">↑</a> [Computer analysis of world champions](http://en.chessbase.com/post/computer-analysis-of-world-champions) by [Søren Riis](S%C3%B8ren_Riis "Søren Riis"), [ChessBase News](ChessBase "ChessBase"), November 02, 2006
9. <a id="cite-ref-9" href="#cite-note-9">↑</a> [Bayesian inference from Wikipedia](https://en.wikipedia.org/wiki/Bayesian_inference)
10. <a id="cite-ref-10" href="#cite-note-10">↑</a> [How I did it: Diogo Ferreira on 4th place in Elo chess ratings competition | no free hunch](http://blog.kaggle.com/2010/11/30/how-i-did-it-diogo-ferreira-on-4th-place-in-elo-chess-ratings-competition/)
11. <a id="cite-ref-11" href="#cite-note-11">↑</a>  ["Intrinsic Chess Ratings" by Regan, Haworth -- seq](http://www.talkchess.com/forum/viewtopic.php?t=65772) by Kai Middleton, [CCC](CCC "CCC"), November 19, 2017
12. <a id="cite-ref-12" href="#cite-note-12">↑</a> [Re: EloStat, Bayeselo and Ordo](http://www.talkchess.com/forum/viewtopic.php?topic_view=threads&p=471004&t=44180) by [Rémi Coulom](R%C3%A9mi_Coulom "Rémi Coulom"), [CCC](CCC "CCC"), June 25, 2012
13. <a id="cite-ref-13" href="#cite-note-13">↑</a> [Re: Understanding and Pushing the Limits of the Elo Rating Algorithm](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=72087&start=3) by [Daniel Shawul](Daniel_Shawul "Daniel Shawul"), [CCC](CCC "CCC"), October 15, 2019
14. <a id="cite-ref-14" href="#cite-note-14">↑</a> [Ply versus ELO](https://www.hiarcs.net/forums/viewtopic.php?t=10004) by Greg, [HIARCS Forum](Computer_Chess_Forums "Computer Chess Forums"), May 30, 2020 » [Diogo R. Ferreira - Impact of the Search Depth ...](Diogo_R._Ferreira#Impact "Diogo R. Ferreira")
15. <a id="cite-ref-15" href="#cite-note-15">↑</a> [Questions regarding rating systems of humans and engines](http://www.talkchess.com/forum/viewtopic.php?t=54571) by [Erik Varend](index.php?title=Erik_Varend&action=edit&redlink=1 "Erik Varend (page does not exist)"), [CCC](CCC "CCC"), December 06, 2014
16. <a id="cite-ref-16" href="#cite-note-16">↑</a> [chess statistics scientific article](http://www.talkchess.com/forum/viewtopic.php?t=60721) by Nuno Sousa, [CCC](CCC "CCC"), July 06, 2016
17. <a id="cite-ref-17" href="#cite-note-17">↑</a> [Personal bests – and why you stop after achieving them: U of T Scarborough expert | University of Toronto Scarborough - News and Events](https://utsc.utoronto.ca/news-events/breaking-research/personal-bests-and-why-you-stop-after-achieving-them-u-t-scarborough-expert) by [Nina Haikara](https://everipedia.org/wiki/lang_en/nina-haikara), February 7, 2018
18. <a id="cite-ref-18" href="#cite-note-18">↑</a> [Understanding and Pushing the Limits of the Elo Rating Algorithm](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=72087) by [Michel Van den Bergh](Michel_Van_den_Bergh "Michel Van den Bergh"), [CCC](CCC "CCC"), October 15, 2019
19. <a id="cite-ref-19" href="#cite-note-19">↑</a> [Delphil 3.3b2 (2334) - Stockfish 030916 (3228), TCEC Season 9 - Rapid, Round 11](http://tcec.chessdom.com/archive.php?se=9&rapid&ga=163), September 16, 2016
20. <a id="cite-ref-20" href="#cite-note-20">↑</a> [Normalized Elo](http://hardy.uhasselt.be/Toga/normalized_elo.pdf) (pdf) by [Michel Van den Bergh](Michel_Van_den_Bergh "Michel Van den Bergh")
21. <a id="cite-ref-21" href="#cite-note-21">↑</a> [Chessanalysis homepage](http://www.chessanalysis.ee/chessanalysiseng.htm) by [Erik Varend](index.php?title=Erik_Varend&action=edit&redlink=1 "Erik Varend (page does not exist)")
22. <a id="cite-ref-22" href="#cite-note-22">↑</a> [wall - Wiktionary](https://en.wiktionary.org/wiki/wall)
23. <a id="cite-ref-23" href="#cite-note-23">↑</a> [regression - Wiktionary](https://en.wiktionary.org/wiki/regression)
24. <a id="cite-ref-24" href="#cite-note-24">↑</a> [Most accurate K-factor - Elo rating system from Wikipedia](https://en.wikipedia.org/wiki/Elo_rating_system#Most_accurate_K-factor)
25. <a id="cite-ref-25" href="#cite-note-25">↑</a> [FIDE Chess Rating calculators: Chess Rating change calculator](https://ratings.fide.com/calculator_rtd.phtml)
26. <a id="cite-ref-26" href="#cite-note-26">↑</a> The primary data source is the [SSDF](SSDF "SSDF"), [Deep Blue](Deep_Blue "Deep Blue") Elo Performance: estimated by perf. against [Kasparov](Garry_Kasparov "Garry Kasparov"), [AlphaZero](AlphaZero "AlphaZero") Elo Performance: estimated by perf. against [Stockfish](Stockfish "Stockfish"), [Leela Chess Zero](Leela_Chess_Zero "Leela Chess Zero") Elo Performance from [LCZ rating list (CCRL estimate)](https://docs.google.com/spreadsheets/d/1XSJiCcQpCLv0fNwrUn7jXjdkZFU63YFEWpdXv6dSSg0/edit#gid=312836954)
27. <a id="cite-ref-27" href="#cite-note-27">↑</a> [Matej Guid](Matej_Guid "Matej Guid"), [Ivan Bratko](Ivan_Bratko "Ivan Bratko") (**2006**). *Computer Analysis of World Chess Champions*. [ICGA Journal, Vol. 29, No. 2](ICGA_Journal#29_2 "ICGA Journal"), [pdf](http://www.ailab.si/matej/doc/Computer_Analysis_of_World_Chess_Champions.pdf)
28. <a id="cite-ref-28" href="#cite-note-28">↑</a> [an interesting study from Erik Varend](http://www.hiarcs.net/forums/viewtopic.php?t=8526) by scandien, [Hiarcs Forum](Computer_Chess_Forums "Computer Chess Forums"), August 13, 2017
