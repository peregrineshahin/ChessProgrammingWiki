...
* [1 Early Ideas](#Early_Ideas)
* [2 Mathematical Projection](#Mathematical_Projection)
* [3 Further Research](#Further_Research)
* [4 Controversy](#Controversy)
* [5 Photos](#Photos)
	+ [5.1 McGill University 1977](#McGill_University_1977)
	+ [5.2 Moscow 1980](#Moscow_1980)
* [6 Timeline](#Timeline)
* [7 Quotes](#Quotes)
	+ [7.1 Rushton and Marsland](#Rushton_and_Marsland)
	+ [7.2 David Kittinger](#David_Kittinger)
	+ [7.3 Reznitskiy and Chudakov](#Reznitskiy_and_Chudakov)
	+ [7.4 Boris Stilman](#Boris_Stilman)
* [8 See also](#See_also)
...
* [11 External Links](#External_Links)
	+ [11.1 Chess Program](#Chess_Program)
	+ [11.2 Misc](#Misc)
...
Botvinnik's early ideas on [attack maps](Attack_and_Defend_Maps "Attack and Defend Maps") were already formulated and published the late 50s and 60s. At [Moscow Central Chess Club](https://en.wikipedia.org/wiki/Chess_Centres) [[3]](#cite_note-3) in 1966, with the skeptical [Georgy Adelson-Velsky](Georgy_Adelson-Velsky "Georgy Adelson-Velsky") and others attending, he introduced the concept of [trajectories](Trajectory "Trajectory") and found [Vladimir Butenko](index.php?title=Vladimir_Butenko&action=edit&redlink=1 "Vladimir Butenko (page does not exist)") as supporter and collaborator. Butenko first implemented the [15x15 vector attacks](Vector_Attacks "Vector Attacks") board representation on a [M-20](M-20 "M-20") computer, [determining trajectories](Distance#15x15 "Distance"). The table below demonstrates the [distance](Distance "Distance") from a square (here c2) on a 8x8 board, superimposed on the 15x15 array in such a way that the from square (c2) coincides with the central square of the 15x15 array, which is the origin, tail, or base of all displacement vectors [[4]](#cite_note-4) .
...
[Boris Stilman](Boris_Stilman "Boris Stilman") gave following example to generate a set or sheave of trajectories for a king moving from f6 to h1 [[5]](#cite_note-5) :
