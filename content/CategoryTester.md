...
A **Tester** in the field of computer chess [tests engines](Engine_Testing "Engine Testing") - in the development phase often in collaboration with the [chess programmer](Category:Chess_Programmer "Category:Chess Programmer") to look for bugs and/or weaknesses of the engine, and/or to provide [match statistics](Match_Statistics "Match Statistics") for [ratings lists](Engine_Rating_Lists "Engine Rating Lists").

## Pages in category "Tester"
...
- [Ted Summers](Ted_Summers "Ted Summers")
