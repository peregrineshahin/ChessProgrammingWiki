...
* [Mikhail Moiseevich Bongard](https://en.wikipedia.org/wiki/Bongard_problem) [[6]](#cite_note-6) (**1967**). *Проблема Узнавания*. The Problem of Recognition, Nauka Press, Moscow, appeared as *Pattern Recognition* in its 1970 English translation
...
* [Hans Berliner](Hans_Berliner "Hans Berliner"), [Carl Ebeling](Carl_Ebeling "Carl Ebeling") (**1989**). *Pattern Knowledge and Search: The SUPREM Architecture.* Artificial Intelligence, Vol. 38, No. 2
...
* [Reijer Grimbergen](Reijer_Grimbergen "Reijer Grimbergen") (**1996**). *Using Pattern Recognition and Selective Deepening to Solve Tsume Shogi*. [3rd Game Programming Workshop](Conferences#GPW "Conferences"), [CiteSeerX](http://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.43.7594) [[7]](#cite_note-7)
...
* [Fernand Gobet](Fernand_Gobet "Fernand Gobet"), [Herbert Simon](Herbert_Simon "Herbert Simon") (**1998**). *Pattern recognition makes search possible: Comments on Holding (1992)*. Psychological Research, Vol. 61, [pdf](http://v-scheiner.brunel.ac.uk/bitstream/2438/816/1/Paper_on_Holding.pdf) [[8]](#cite_note-8)
...
* [Marcel van Kervinck](Marcel_van_Kervinck "Marcel van Kervinck") (**2002**). *[A pattern-recognition strategy for chess position evaluation](http://marcelk.net/thesis/talk-eval-rookie/sld001.htm)*. Slides from *The design and implementation of the Rookie 2.0 Chess Playing Program*. [[9]](#cite_note-9)
...
* [Can a Bayesian spam filter play chess?](http://dbacl.sourceforge.net/spam_chess-1.html) by [Laird A. Breyer](http://www.lbreyer.com/) [[10]](#cite_note-10)
* [Bongard problem from Wikipedia](https://en.wikipedia.org/wiki/Bongard_problem)
...
1. [↑](#cite_ref-1) Clipping from [Chess pattern](http://melmolly.deviantart.com/art/Chess-pattern-177292334) by [~Melmolly on deviantART](http://melmolly.deviantart.com/), [Graphics Software by Xara](http://www.xara.com)
2. [↑](#cite_ref-2) [Pattern recognition from Wikipedia](https://en.wikipedia.org/wiki/Pattern_recognition)
3. [↑](#cite_ref-3) [Peter W. Frey](Peter_W._Frey "Peter W. Frey") (**1986**). *Fuzzy Production Rules in Chess*. [ICCA Journal, Vol. 9, No. 4](ICGA_Journal#9_4 "ICGA Journal")
4. [↑](#cite_ref-4) [Ratio Club from Wikipedia](https://en.wikipedia.org/wiki/Ratio_Club)
5. [↑](#cite_ref-5) [Royal Radar Establishment from Wikipedia](https://en.wikipedia.org/wiki/Royal_Radar_Establishment)
6. [↑](#cite_ref-6) [Mikhail Moiseevich Bongard - Михаил Моисеевич Бонгард](http://www.foundalis.com/res/Mikhail_Moiseevich_Bongard.html)
7. [↑](#cite_ref-7) [Tsumeshogi from Wikipedia](https://en.wikipedia.org/wiki/Tsumeshogi)
8. [↑](#cite_ref-8) [Dennis H. Holding](index.php?title=Dennis_H._Holding&action=edit&redlink=1 "Dennis H. Holding (page does not exist)") (**1992**). *Theories of Chess Skill*. Psychological Research, Vol. 54, No. 1
...
10. [↑](#cite_ref-10) [Bayesian spam filtering - Wikipedia](https://en.wikipedia.org/wiki/Bayesian_spam_filtering)
