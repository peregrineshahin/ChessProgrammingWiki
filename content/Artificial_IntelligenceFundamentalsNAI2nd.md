---
title: Artificial IntelligenceFundamentalsNAI2nd
---
...
- [Azlan Iqbal](Azlan_Iqbal "Azlan Iqbal") (**2006**). *Is Aesthetics Computable?* [ICGA Journal, Vol. 29, No. 1](ICGA_Journal#29_1 "ICGA Journal"), [pdf](http://metalab.uniten.edu.my/%7Eazlan/Research/pdfs/iac_azlan.pdf)
...
1. <a id="cite-ref-6" href="#cite-note-6">↑</a> [Peter W. Frey](Peter_W._Frey "Peter W. Frey") (**1991**). *Memory-Based Expertise: Computer Chess vs. AI*, [ICCA Journal, Vol. 14, No. 4](ICGA_Journal#14_4 "ICGA Journal")
...
1. <a id="cite-ref-17" href="#cite-note-17">↑</a> [Peter W. Frey](Peter_W._Frey "Peter W. Frey") (**1991**). *Memory-Based Expertise: Computer Chess vs. AI*. [ICCA Journal, Vol. 14, No. 4](ICGA_Journal#14_4 "ICGA Journal")
1. <a id="cite-ref-18" href="#cite-note-18">↑</a> [John McCarthy](John_McCarthy "John McCarthy") (**1997**). *[AI as Sport](http://www-formal.stanford.edu/jmc/newborn/newborn.html).* Science, Vol. 276
1. <a id="cite-ref-19" href="#cite-note-19">↑</a> [Monroe Newborn](Monroe_Newborn "Monroe Newborn") (**1997**). *Kasparov versus DEEP BLUE: Computer Chess Comes of Age.* Springer
1. <a id="cite-ref-20" href="#cite-note-20">↑</a> [Making Computer Chess Scientific](http://www-formal.stanford.edu/jmc/chess.html) by [John McCarthy](John_McCarthy "John McCarthy")
1. <a id="cite-ref-21" href="#cite-note-21">↑</a> [Re: Chess vs Go // AI vs IA](http://computer-go.org/pipermail/computer-go/2010-June/000376.html) by [Gian-Carlo Pascutto](Gian-Carlo_Pascutto "Gian-Carlo Pascutto"), June 02, 2010
1. <a id="cite-ref-22" href="#cite-note-22">↑</a> [Graham Kendall](Graham_Kendall "Graham Kendall"), [Jonathan Schaeffer](Jonathan_Schaeffer "Jonathan Schaeffer") (**2006**). *[Poker](http://ilk.uvt.nl/icga/games/Poker/)*. [ICGA Journal, Vol. 29, No. 3](ICGA_Journal#29_3 "ICGA Journal")
1. <a id="cite-ref-23" href="#cite-note-23">↑</a> [Rosenblatt's Contributions](http://csis.pace.edu/~ctappert/srd2011/rosenblatt-contributions.htm)
1. <a id="cite-ref-24" href="#cite-note-24">↑</a> [General Problem Solver from Wikipedia](https://en.wikipedia.org/wiki/General_Problem_Solver)
1. <a id="cite-ref-25" href="#cite-note-25">↑</a> [Publications of John Maynard Smith](http://www.lifesci.sussex.ac.uk/CSE/members/jms/JMSpublications.pdf) (pdf)
1. <a id="cite-ref-26" href="#cite-note-26">↑</a> [The abandonment of connectionism in 1969 - Wikipedia](https://en.wikipedia.org/wiki/AI_winter#The_abandonment_of_connectionism_in_1969)
1. <a id="cite-ref-27" href="#cite-note-27">↑</a> [Frank Rosenblatt](https://en.wikipedia.org/wiki/Frank_Rosenblatt) (**1962**). *[Principles of Neurodynamics: Perceptrons and the Theory of Brain Mechanisms](http://catalog.hathitrust.org/Record/000203591)*. Spartan Books
1. <a id="cite-ref-28" href="#cite-note-28">↑</a> [Physical symbol system from Wikipedia](https://en.wikipedia.org/wiki/Physical_symbol_system)
1. <a id="cite-ref-29" href="#cite-note-29">↑</a> [K-line (artificial intelligence) from Wikipedia](https://en.wikipedia.org/wiki/K-line_%28artificial_intelligence%29)
1. <a id="cite-ref-30" href="#cite-note-30">↑</a> [John McCarthy](John_McCarthy "John McCarthy") (**1997**). *Chess as the Drosophila of AI*. Computer Science Department, [Stanford University](Stanford_University "Stanford University"), condensed version of the 1990 paper, [pdf](http://innovation.it.uts.edu.au/projectjmc/articles/drosophila/drosophila.pdf)
1. <a id="cite-ref-31" href="#cite-note-31">↑</a> [Re: ICCA Journal Sinks To A New Low](https://www.stmintz.com/ccc/index.php?id=14647) by [Amir Ban](Amir_Ban "Amir Ban"), [CCC](CCC "CCC"), January 25, 1998
1. <a id="cite-ref-32" href="#cite-note-32">↑</a> [Charles E. M. Dunlop](https://www.biblio.com/dunlop-charles-e-m/author/1216693) (**2000**). *Book Review 'Mind Versus Computer'* . [Minds and Machines](https://link.springer.com/journal/11023), Vol. 10, No. 2
1. <a id="cite-ref-33" href="#cite-note-33">↑</a> [Matjaž Gams](Matja%C5%BE_Gams "Matjaž Gams") (**2002**). *[The Turing machine may not be the universal machine](https://link.springer.com/article/10.1023%2FA%3A1013746105950)*. [Minds and Machines](https://link.springer.com/journal/11023), Vol. 12, No. 1
1. <a id="cite-ref-34" href="#cite-note-34">↑</a> [Christian Jongeneel](Mathematician#CJongeneel "Mathematician") (**1996**). *[The informatical worldview, an inquiry into the methodology of computer science](http://repository.tudelft.nl/view/ir/uuid%3A384c7d0f-1869-4262-b8dd-e263637cb035/)*. Ph.D. thesis, [Delft University of Technology](Delft_University_of_Technology "Delft University of Technology"), advisor [Henk Koppelaar](Henk_Koppelaar "Henk Koppelaar"), [The evolution of information in man and machine | Christian Jongeneel](http://www.christianjongeneel.nl/gepubliceerde-boeken/de-programmeur-en-de-kangoeroedans/the-evolution-of-information-in-man-and-machine/)
1. <a id="cite-ref-35" href="#cite-note-35">↑</a> [Terasem Journal of Personal Cyberconsciousness - Marvin Lee Minsky discussing his book, The Emotion Machine](http://www.terasemjournals.org/PCJournal/PC0303/mm1.html)
1. <a id="cite-ref-36" href="#cite-note-36">↑</a> [Mark Watson · GitHub](https://github.com/mark-watson)
1. <a id="cite-ref-37" href="#cite-note-37">↑</a> [Java](Java "Java") [implementation of algorithms](http://code.google.com/p/aima-java/) from [Norvig](Peter_Norvig "Peter Norvig") and [Russell's](Stuart_Russell "Stuart Russell") *[Artificial Intelligence: A Modern Approach](http://aima.cs.berkeley.edu/)*. 3rd edition
1. <a id="cite-ref-38" href="#cite-note-38">↑</a> [Chess Metaphors – Artificial Intelligence and the Human Mind](http://www.chessbase.com/newsdetail.asp?newsid=6097) by [Diego Rasskin-Gutman](index.php?title=Diego_Rasskin-Gutman&action=edit&redlink=1 "Diego Rasskin-Gutman (page does not exist)"), [ChessBase News](ChessBase "ChessBase"), January 28, 2010
1. <a id="cite-ref-39" href="#cite-note-39">↑</a> [Dap Hartmann](Dap_Hartmann "Dap Hartmann") (**2010**). *Sander Bakkes: Rapid Adaptation of Video Game AI*. Review, [ICGA Journal, Vol. 34, No. 1](ICGA_Journal#34_1 "ICGA Journal")
1. <a id="cite-ref-40" href="#cite-note-40">↑</a> [Transcript](https://www.ted.com/talks/garry_kasparov_don_t_fear_intelligent_machines_work_with_them/transcript) of [Kasparov’s TED talk](https://www.ted.com/speakers/garry_kasparov), May 2017
1. <a id="cite-ref-41" href="#cite-note-41">↑</a> [20 Years after Deep Blue: How AI Has Advanced Since Conquering Chess](https://www.scientificamerican.com/article/20-years-after-deep-blue-how-ai-has-advanced-since-conquering-chess/) by [Larry Greenemeier](https://www.crunchbase.com/person/larry-greenemeier), [Scientific American](Scientific_American "Scientific American"), June 2, 2017
1. <a id="cite-ref-42" href="#cite-note-42">↑</a> [Connectionism from Wikipedia](https://en.wikipedia.org/wiki/Connectionism)
1. <a id="cite-ref-43" href="#cite-note-43">↑</a> [Marvin Minsky](Marvin_Minsky "Marvin Minsky"), [Seymour Papert](Mathematician#SPapert "Mathematician") (**1969**). *[Perceptrons](https://en.wikipedia.org/wiki/Perceptrons_%28book%29)*.
1. <a id="cite-ref-44" href="#cite-note-44">↑</a> [Intelligence from Wikipedia](https://en.wikipedia.org/wiki/Intelligence)
