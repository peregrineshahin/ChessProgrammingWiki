...
* [2 New Architecture](#new-architecture)
	+ [2.1 Declaration](#declaration)
	+ [2.2 Piece List Traversal](#piece-list-traversal)
		- [2.2.1 Forward](#forward)
		- [2.2.2 Backward](#backward)
	+ [2.3 Incremental Update](#incremental-update)
		- [2.3.1 Make Moves](#make-moves)
		- [2.3.2 Unmake Moves](#unmake-moves)
...
* [9 What links here?](#what-links-here.3f)
...
[Peter Jennings'](Peter_Jennings "Peter Jennings") board representation in [MicroChess](MicroChess "MicroChess") completely relies on an array of 32 [Bytes](Byte "Byte") for each possible piece. Content of the following addresses were either square coordinates in the 0..63 range, or, to indicate a piece was captured and no longer on the board, appropriate values outside that range. After [make](Make_Move "Make Move")-[unmake](Unmake_Move "Unmake Move"), Jennings reversed the board by subtracting coordinates from 63 (octal 077), to keep all nodes searched the same [color](Color "Color"). To alter some bytes inside those addresses with a Monitor program was also the way to enter positions in the first [6502](6502 "6502")-based [MicroChess](MicroChess "MicroChess") on a [KIM-1](KIM-1 "KIM-1") <a id="cite-note-2" href="#cite-ref-2">[2]</a>.
...
1. <a id="cite-ref-1" href="#cite-note-1">[1]</a> [Paul Klee](Category:Paul_Klee "Category:Paul Klee") - Birds Swooping Down and Arrows, 1919, [[1]](https://commons.wikimedia.org/wiki/File:Birds_Swooping_Down_and_Arrows_MET_DT7784.jpg) [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons), [Metropolitan Museum of Art](https://en.wikipedia.org/wiki/Metropolitan_Museum_of_Art)
...
4. <a id="cite-ref-4" href="#cite-note-4">[4]</a> [Re: Is there such a thing as branchless move generation?](http://www.talkchess.com/forum/viewtopic.php?topic_view=threads&p=468678&t=43971) by [Daniel Shawul](Daniel_Shawul "Daniel Shawul"), [CCC](CCC "CCC"), June 10, 2012
